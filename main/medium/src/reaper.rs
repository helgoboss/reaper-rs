...
use crate::metering::{NanoResponseTime, SingleThreadedHdrHistogram};
#[cfg(feature = "reaper-meter")]
use metered::metered;
...
#[cfg(feature = "reaper-meter")]
type MultiThreadNanos = NanoResponseTime;

#[cfg(feature = "reaper-meter")]
type SingleThreadNanos = NanoResponseTime<SingleThreadedHdrHistogram>;
