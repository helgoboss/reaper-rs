...
pub mod virt_keys {
    ...
    pub const LBUTTON: VirtKey = VirtKey(raw::VK_LBUTTON as _);
    pub const RBUTTON: VirtKey = VirtKey(raw::VK_RBUTTON as _);
    pub const MBUTTON: VirtKey = VirtKey(raw::VK_MBUTTON as _);
    pub const BACK: VirtKey = VirtKey(raw::VK_BACK as _);
    pub const TAB: VirtKey = VirtKey(raw::VK_TAB as _);
    pub const CLEAR: VirtKey = VirtKey(raw::VK_CLEAR as _);
    pub const RETURN: VirtKey = VirtKey(raw::VK_RETURN as _);
    ...
    pub const PAUSE: VirtKey = VirtKey(raw::VK_PAUSE as _);
    pub const CAPITAL: VirtKey = VirtKey(raw::VK_CAPITAL as _);
    pub const ESCAPE: VirtKey = VirtKey(raw::VK_ESCAPE as _);
    pub const SPACE: VirtKey = VirtKey(raw::VK_SPACE as _);
    pub const PRIOR: VirtKey = VirtKey(raw::VK_PRIOR as _);
    pub const NEXT: VirtKey = VirtKey(raw::VK_NEXT as _);
    pub const END: VirtKey = VirtKey(raw::VK_END as _);
    pub const HOME: VirtKey = VirtKey(raw::VK_HOME as _);
    pub const LEFT: VirtKey = VirtKey(raw::VK_LEFT as _);
    pub const UP: VirtKey = VirtKey(raw::VK_UP as _);
    pub const RIGHT: VirtKey = VirtKey(raw::VK_RIGHT as _);
    pub const DOWN: VirtKey = VirtKey(raw::VK_DOWN as _);
    pub const SELECT: VirtKey = VirtKey(raw::VK_SELECT as _);
    pub const PRINT: VirtKey = VirtKey(raw::VK_PRINT as _);
    pub const SNAPSHOT: VirtKey = VirtKey(raw::VK_SNAPSHOT as _);
    pub const INSERT: VirtKey = VirtKey(raw::VK_INSERT as _);
    pub const DELETE: VirtKey = VirtKey(raw::VK_DELETE as _);
    pub const HELP: VirtKey = VirtKey(raw::VK_HELP as _);
    pub const LWIN: VirtKey = VirtKey(raw::VK_LWIN as _);
    pub const NUMPAD0: VirtKey = VirtKey(raw::VK_NUMPAD0 as _);
    pub const NUMPAD1: VirtKey = VirtKey(raw::VK_NUMPAD1 as _);
    pub const NUMPAD2: VirtKey = VirtKey(raw::VK_NUMPAD2 as _);
    pub const NUMPAD3: VirtKey = VirtKey(raw::VK_NUMPAD3 as _);
    pub const NUMPAD4: VirtKey = VirtKey(raw::VK_NUMPAD4 as _);
    pub const NUMPAD5: VirtKey = VirtKey(raw::VK_NUMPAD5 as _);
    pub const NUMPAD6: VirtKey = VirtKey(raw::VK_NUMPAD6 as _);
    pub const NUMPAD7: VirtKey = VirtKey(raw::VK_NUMPAD7 as _);
    pub const NUMPAD8: VirtKey = VirtKey(raw::VK_NUMPAD8 as _);
    pub const NUMPAD9: VirtKey = VirtKey(raw::VK_NUMPAD9 as _);
    pub const MULTIPLY: VirtKey = VirtKey(raw::VK_MULTIPLY as _);
    pub const ADD: VirtKey = VirtKey(raw::VK_ADD as _);
    pub const SEPARATOR: VirtKey = VirtKey(raw::VK_SEPARATOR as _);
    pub const SUBTRACT: VirtKey = VirtKey(raw::VK_SUBTRACT as _);
    pub const DECIMAL: VirtKey = VirtKey(raw::VK_DECIMAL as _);
    pub const DIVIDE: VirtKey = VirtKey(raw::VK_DIVIDE as _);
    pub const F1: VirtKey = VirtKey(raw::VK_F1 as _);
    pub const F2: VirtKey = VirtKey(raw::VK_F2 as _);
    pub const F3: VirtKey = VirtKey(raw::VK_F3 as _);
    pub const F4: VirtKey = VirtKey(raw::VK_F4 as _);
    pub const F5: VirtKey = VirtKey(raw::VK_F5 as _);
    pub const F6: VirtKey = VirtKey(raw::VK_F6 as _);
    pub const F7: VirtKey = VirtKey(raw::VK_F7 as _);
    pub const F8: VirtKey = VirtKey(raw::VK_F8 as _);
    pub const F9: VirtKey = VirtKey(raw::VK_F9 as _);
    pub const F10: VirtKey = VirtKey(raw::VK_F10 as _);
    pub const F11: VirtKey = VirtKey(raw::VK_F11 as _);
    pub const F12: VirtKey = VirtKey(raw::VK_F12 as _);
    pub const F13: VirtKey = VirtKey(raw::VK_F13 as _);
    pub const F14: VirtKey = VirtKey(raw::VK_F14 as _);
    pub const F15: VirtKey = VirtKey(raw::VK_F15 as _);
    pub const F16: VirtKey = VirtKey(raw::VK_F16 as _);
    pub const F17: VirtKey = VirtKey(raw::VK_F17 as _);
    pub const F18: VirtKey = VirtKey(raw::VK_F18 as _);
    pub const F19: VirtKey = VirtKey(raw::VK_F19 as _);
    pub const F20: VirtKey = VirtKey(raw::VK_F20 as _);
    pub const F21: VirtKey = VirtKey(raw::VK_F21 as _);
    pub const F22: VirtKey = VirtKey(raw::VK_F22 as _);
    pub const F23: VirtKey = VirtKey(raw::VK_F23 as _);
    pub const F24: VirtKey = VirtKey(raw::VK_F24 as _);
    pub const NUMLOCK: VirtKey = VirtKey(raw::VK_NUMLOCK as _);
    pub const SCROLL: VirtKey = VirtKey(raw::VK_SCROLL as _);
}
