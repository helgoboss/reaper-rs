...
// Generated by REAPER v7.22+dev0903a/macOS-arm64
...
void (* REAPERAPI_FUNCNAME(__mergesort))(void* base,
    size_t nmemb,
    size_t size,
...
bool (* REAPERAPI_FUNCNAME(AddCustomizableMenu))(const char* menuidstr,
    const char* menuname,
...
int (* REAPERAPI_FUNCNAME(AddProjectMarker))(ReaProject* proj,
    bool isrgn,
    double pos,
    double rgnend,
    const char* name,
...
int (* REAPERAPI_FUNCNAME(AddProjectMarker2))(ReaProject* proj,
    bool isrgn,
    double pos,
    double rgnend,
    const char* name,
...
int (* REAPERAPI_FUNCNAME(AddRemoveReaScript))(bool add,
    int sectionID,
    const char* scriptfn,
    bool commit);
#endif
...
bool (* REAPERAPI_FUNCNAME(AddTempoTimeSigMarker))(ReaProject* proj,
    double timepos,
    double bpm,
    int timesig_num,
    int timesig_denom,
...
bool (* REAPERAPI_FUNCNAME(ApplyNudge))(ReaProject* project,
    int nudgeflag,
    int nudgewhat,
    int nudgeunits,
    double value,
...
double (* REAPERAPI_FUNCNAME(CalculateNormalization))(PCM_source* source,
    int normalizeTo,
    double normalizeTarget,
    double normalizeStart,
    double normalizeEnd);
#endif
...
int (* REAPERAPI_FUNCNAME(CalculatePeaks))(PCM_source_transfer_t* srcBlock,
...
int (* REAPERAPI_FUNCNAME(CalculatePeaksFloatSrcPtr))(PCM_source_transfer_t* srcBlock,
    PCM_source_peaktransfer_t* pksBlock);
#endif
...
int (* REAPERAPI_FUNCNAME(CountProjectMarkers))(ReaProject* proj,
    int* num_markersOut,
    int* num_regionsOut);
#endif
...
MediaItem* (* REAPERAPI_FUNCNAME(CreateNewMIDIItemInProj))(MediaTrack* track,
    double starttime,
    double endtime,
...
int (* REAPERAPI_FUNCNAME(CSurf_OnInputMonitorChangeEx))(MediaTrack* trackid,
    int monitor,
    bool allowgang);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_OnOscControlMessage2))(const char* msg,
    const float* arg,
    const char* argstr);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnPanChangeEx))(MediaTrack* trackid,
    double pan,
    bool relative,
    bool allowGang);
#endif
...
bool (* REAPERAPI_FUNCNAME(CSurf_OnRecArmChangeEx))(MediaTrack* trackid,
    int recarm,
    bool allowgang);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnRecvPanChange))(MediaTrack* trackid,
    int recv_index,
    double pan,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnRecvVolumeChange))(MediaTrack* trackid,
    int recv_index,
    double volume,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnSendPanChange))(MediaTrack* trackid,
    int send_index,
    double pan,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnSendVolumeChange))(MediaTrack* trackid,
    int send_index,
    double volume,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnVolumeChange))(MediaTrack* trackid,
    double volume,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnVolumeChangeEx))(MediaTrack* trackid,
    double volume,
    bool relative,
    bool allowGang);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnWidthChange))(MediaTrack* trackid,
    double width,
    bool relative);
#endif
...
double (* REAPERAPI_FUNCNAME(CSurf_OnWidthChangeEx))(MediaTrack* trackid,
    double width,
    bool relative,
    bool allowGang);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetPlayState))(bool play,
    bool pause,
    bool rec,
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfaceMute))(MediaTrack* trackid,
    bool mute,
    IReaperControlSurface* ignoresurf);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfacePan))(MediaTrack* trackid,
    double pan,
    IReaperControlSurface* ignoresurf);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfaceRecArm))(MediaTrack* trackid,
    bool recarm,
    IReaperControlSurface* ignoresurf);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfaceSelected))(MediaTrack* trackid,
    bool selected,
    IReaperControlSurface* ignoresurf);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfaceSolo))(MediaTrack* trackid,
    bool solo,
    IReaperControlSurface* ignoresurf);
#endif
...
void (* REAPERAPI_FUNCNAME(CSurf_SetSurfaceVolume))(MediaTrack* trackid,
    double volume,
    IReaperControlSurface* ignoresurf);
#endif
...
bool (* REAPERAPI_FUNCNAME(DeleteActionShortcut))(KbdSectionInfo* section,
    int cmdID,
    int shortcutidx);
#endif
...
bool (* REAPERAPI_FUNCNAME(DeleteEnvelopePointEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    int ptidx);
#endif
...
bool (* REAPERAPI_FUNCNAME(DeleteEnvelopePointRange))(TrackEnvelope* envelope,
    double time_start,
    double time_end);
#endif
...
bool (* REAPERAPI_FUNCNAME(DeleteEnvelopePointRangeEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    double time_start,
    double time_end);
#endif
...
bool (* REAPERAPI_FUNCNAME(DeleteProjectMarker))(ReaProject* proj,
...
int (* REAPERAPI_FUNCNAME(DeleteTakeStretchMarkers))(MediaItem_Take* take,
    int idx,
...
bool (* REAPERAPI_FUNCNAME(DoActionShortcutDialog))(HWND hwnd,
...
void (* REAPERAPI_FUNCNAME(DockWindowAddEx))(HWND hwnd,
    const char* name,
    const char* identstr,
    bool allowShow);
#endif
...
bool (* REAPERAPI_FUNCNAME(EnumInstalledFX))(int index,
    const char** nameOut,
    const char** identOut);
#endif
...
int (* REAPERAPI_FUNCNAME(EnumProjectMarkers))(int idx,
    bool* isrgnOut,
    double* posOut,
    double* rgnendOut,
    const char** nameOut,
...
int (* REAPERAPI_FUNCNAME(EnumProjectMarkers2))(ReaProject* proj,
    int idx,
    bool* isrgnOut,
    double* posOut,
    double* rgnendOut,
...
int (* REAPERAPI_FUNCNAME(EnumProjectMarkers3))(ReaProject* proj,
    int idx,
    bool* isrgnOut,
    double* posOut,
    double* rgnendOut,
...
ReaProject* (* REAPERAPI_FUNCNAME(EnumProjects))(int idx,
    char* projfnOutOptional,
...
bool (* REAPERAPI_FUNCNAME(EnumProjExtState))(ReaProject* proj,
    const char* extname,
    int idx,
    char* keyOutOptional,
...
MediaTrack* (* REAPERAPI_FUNCNAME(EnumRegionRenderMatrix))(ReaProject* proj,
    int regionindex,
    int rendertrack);
#endif
...
bool (* REAPERAPI_FUNCNAME(EnumTrackMIDIProgramNames))(int track,
    int programNumber,
    char* programName,
    int programName_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(EnumTrackMIDIProgramNamesEx))(ReaProject* proj,
    MediaTrack* track,
    int programNumber,
    char* programName,
    int programName_sz);
...
int (* REAPERAPI_FUNCNAME(Envelope_Evaluate))(TrackEnvelope* envelope,
    double time,
    double samplerate,
...
void (* REAPERAPI_FUNCNAME(Envelope_FormatValue))(TrackEnvelope* env,
    double value,
    char* bufOut,
    int bufOut_sz);
#endif
...
MediaItem_Take* (* REAPERAPI_FUNCNAME(Envelope_GetParentTake))(TrackEnvelope* env,
    int* indexOut,
    int* index2Out);
#endif
...
MediaTrack* (* REAPERAPI_FUNCNAME(Envelope_GetParentTrack))(TrackEnvelope* env,
    int* indexOut,
    int* index2Out);
#endif
...
void (* REAPERAPI_FUNCNAME(format_timestr_len))(double tpos,
    char* buf,
    int buf_sz,
    double offset,
    int modeoverride);
...
void (* REAPERAPI_FUNCNAME(format_timestr_pos))(double tpos,
    char* buf,
    int buf_sz,
    int modeoverride);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetActionShortcutDesc))(KbdSectionInfo* section,
    int cmdID,
    int shortcutidx,
    char* descOut,
    int descOut_sz);
...
int (* REAPERAPI_FUNCNAME(GetAudioAccessorSamples))(AudioAccessor* accessor,
    int samplerate,
    int numchannels,
...
bool (* REAPERAPI_FUNCNAME(GetAudioDeviceInfo))(const char* attribute,
    char* descOut,
    int descOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetEnvelopePoint))(TrackEnvelope* envelope,
    int ptidx,
    double* timeOut,
    double* valueOut,
    int* shapeOut,
...
int (* REAPERAPI_FUNCNAME(GetEnvelopePointByTimeEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    double time);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetEnvelopePointEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    int ptidx,
    double* timeOut,
    double* valueOut,
...
bool (* REAPERAPI_FUNCNAME(GetEnvelopeStateChunk))(TrackEnvelope* env,
    char* strNeedBig,
    int strNeedBig_sz,
    bool isundoOptional);
#endif
...
int (* REAPERAPI_FUNCNAME(GetFocusedFX2))(int* tracknumberOut,
    int* itemnumberOut,
    int* fxnumberOut);
#endif
...
TrackEnvelope* (* REAPERAPI_FUNCNAME(GetFXEnvelope))(MediaTrack* track,
    int fxindex,
    int parameterindex,
    bool create);
#endif
...
MediaItem* (* REAPERAPI_FUNCNAME(GetItemFromPoint))(int screen_x,
    int screen_y,
    bool allow_locked,
...
bool (* REAPERAPI_FUNCNAME(GetItemStateChunk))(MediaItem* item,
    char* strNeedBig,
    int strNeedBig_sz,
    bool isundoOptional);
#endif
...
void (* REAPERAPI_FUNCNAME(GetLastMarkerAndCurRegion))(ReaProject* proj,
    double time,
    int* markeridxOut,
    int* regionidxOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetLastTouchedFX))(int* tracknumberOut,
    int* fxnumberOut,
    int* paramnumberOut);
#endif
...
int (* REAPERAPI_FUNCNAME(GetMediaFileMetadata))(PCM_source* mediaSource,
...
int (* REAPERAPI_FUNCNAME(GetMediaItemTake_Peaks))(MediaItem_Take* take,
    double peakrate,
    double starttime,
    int numchannels,
    int numsamplesperchannel,
...
MediaItem_Take* (* REAPERAPI_FUNCNAME(GetMediaItemTakeByGUID))(ReaProject* project,
    const GUID* guid);
#endif
...
double (* REAPERAPI_FUNCNAME(GetMediaItemTakeInfo_Value))(MediaItem_Take* take,
    const char* parmname);
#endif
...
void (* REAPERAPI_FUNCNAME(GetMediaSourceFileName))(PCM_source* source,
    char* filenamebufOut,
    int filenamebufOut_sz);
#endif
...
void (* REAPERAPI_FUNCNAME(GetMediaSourceType))(PCM_source* source,
    char* typebufOut,
    int typebufOut_sz);
#endif
...
void (* REAPERAPI_FUNCNAME(GetMouseModifier))(const char* context,
    int modifier_flag,
    char* actionOut,
    int actionOut_sz);
#endif
...
void (* REAPERAPI_FUNCNAME(GetPeakFileNameEx))(const char* fn,
    char* buf,
    int buf_sz,
    bool forWrite);
#endif
...
void (* REAPERAPI_FUNCNAME(GetPeakFileNameEx2))(const char* fn,
    char* buf,
    int buf_sz,
    bool forWrite,
    const char* peaksfileextension);
#endif
...
void* (* REAPERAPI_FUNCNAME(GetPeaksBitmap))(PCM_source_peaktransfer_t* pks,
    double maxamp,
    int w,
    int h,
    LICE_IBitmap* bmp);
...
void (* REAPERAPI_FUNCNAME(GetProjectTimeSignature2))(ReaProject* proj,
    double* bpmOut,
    double* bpiOut);
#endif
...
int (* REAPERAPI_FUNCNAME(GetProjExtState))(ReaProject* proj,
    const char* extname,
    const char* key,
    char* valOutNeedBig,
    int valOutNeedBig_sz);
#endif
...
MediaTrack* (* REAPERAPI_FUNCNAME(GetSelectedTrack2))(ReaProject* proj,
    int seltrackidx,
    bool wantmaster);
#endif
...
void (* REAPERAPI_FUNCNAME(GetSet_ArrangeView2))(ReaProject* proj,
    bool isSet,
    int screen_x_start,
    int screen_x_end,
    double* start_timeInOut,
    double* end_timeInOut);
#endif
...
void (* REAPERAPI_FUNCNAME(GetSet_LoopTimeRange))(bool isSet,
    bool isLoop,
    double* startOut,
    double* endOut,
    bool allowautoseek);
...
void (* REAPERAPI_FUNCNAME(GetSet_LoopTimeRange2))(ReaProject* proj,
    bool isSet,
    bool isLoop,
    double* startOut,
    double* endOut,
...
double (* REAPERAPI_FUNCNAME(GetSetAutomationItemInfo))(TrackEnvelope* env,
    int autoitem_idx,
    const char* desc,
    double value,
    bool is_set);
...
bool (* REAPERAPI_FUNCNAME(GetSetAutomationItemInfo_String))(TrackEnvelope* env,
    int autoitem_idx,
    const char* desc,
    char* valuestrNeedBig,
    bool is_set);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetEnvelopeInfo_String))(TrackEnvelope* env,
    const char* parmname,
    char* stringNeedBig,
    bool setNewValue);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetEnvelopeState2))(TrackEnvelope* env,
    char* str,
    int str_sz,
    bool isundo);
#endif
...
void* (* REAPERAPI_FUNCNAME(GetSetMediaItemInfo))(MediaItem* item,
    const char* parmname,
    void* setNewValue);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetMediaItemInfo_String))(MediaItem* item,
    const char* parmname,
    char* stringNeedBig,
    bool setNewValue);
#endif
...
void* (* REAPERAPI_FUNCNAME(GetSetMediaItemTakeInfo))(MediaItem_Take* tk,
    const char* parmname,
    void* setNewValue);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetMediaItemTakeInfo_String))(MediaItem_Take* tk,
    const char* parmname,
    char* stringNeedBig,
    bool setNewValue);
#endif
...
void* (* REAPERAPI_FUNCNAME(GetSetMediaTrackInfo))(MediaTrack* tr,
    const char* parmname,
    void* setNewValue);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetMediaTrackInfo_String))(MediaTrack* tr,
    const char* parmname,
    char* stringNeedBig,
    bool setNewValue);
#endif
...
void (* REAPERAPI_FUNCNAME(GetSetProjectAuthor))(ReaProject* proj,
    bool set,
    char* author,
    int author_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(GetSetProjectGrid))(ReaProject* project,
    bool set,
...
double (* REAPERAPI_FUNCNAME(GetSetProjectInfo))(ReaProject* project,
    const char* desc,
    double value,
    bool is_set);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetSetProjectInfo_String))(ReaProject* project,
    const char* desc,
    char* valuestrNeedBig,
    bool is_set);
#endif
...
void (* REAPERAPI_FUNCNAME(GetSetProjectNotes))(ReaProject* proj,
    bool set,
    char* notesNeedBig,
    int notesNeedBig_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(GetSetTempoTimeSigMarkerFlag))(ReaProject* project,
    int point_index,
    int flag,
    bool is_set);
#endif
...
unsigned int (* REAPERAPI_FUNCNAME(GetSetTrackGroupMembership))(MediaTrack* tr,
...
unsigned int (* REAPERAPI_FUNCNAME(GetSetTrackGroupMembershipEx))(MediaTrack* tr,
    const char* groupname,
    int offset,
    unsigned int setmask,
    unsigned int setvalue);
...
unsigned int (* REAPERAPI_FUNCNAME(GetSetTrackGroupMembershipHigh))(MediaTrack* tr,
    const char* groupname,
    unsigned int setmask,
    unsigned int setvalue);
#endif
...
const char* (* REAPERAPI_FUNCNAME(GetSetTrackMIDISupportFile))(ReaProject* proj,
    MediaTrack* track,
    int which,
    const char* filename);
#endif
...
void* (* REAPERAPI_FUNCNAME(GetSetTrackSendInfo))(MediaTrack* tr,
    int category,
    int sendidx,
    const char* parmname,
    void* setNewValue);
...
bool (* REAPERAPI_FUNCNAME(GetSetTrackSendInfo_String))(MediaTrack* tr,
    int category,
    int sendidx,
    const char* parmname,
    char* stringNeedBig,
...
bool (* REAPERAPI_FUNCNAME(GetSetTrackState2))(MediaTrack* track,
    char* str,
    int str_sz,
    bool isundo);
#endif
...
TrackEnvelope* (* REAPERAPI_FUNCNAME(GetTakeEnvelopeByName))(MediaItem_Take* take,
    const char* envname);
#endif
...
double (* REAPERAPI_FUNCNAME(GetTakeMarker))(MediaItem_Take* take,
    int idx,
    char* nameOut,
    int nameOut_sz,
    int* colorOutOptional);
#endif
...
int (* REAPERAPI_FUNCNAME(GetTakeStretchMarker))(MediaItem_Take* take,
    int idx,
    double* posOut,
...
bool (* REAPERAPI_FUNCNAME(GetTCPFXParm))(ReaProject* project,
    MediaTrack* track,
    int index,
    int* fxindexOut,
    int* parmidxOut);
...
bool (* REAPERAPI_FUNCNAME(GetTempoMatchPlayRate))(PCM_source* source,
    double srcscale,
    double position,
    double mult,
    double* rateOut,
...
bool (* REAPERAPI_FUNCNAME(GetTempoTimeSigMarker))(ReaProject* proj,
    int ptidx,
    double* timeposOut,
    int* measureposOut,
    double* beatposOut,
...
MediaTrack* (* REAPERAPI_FUNCNAME(GetThingFromPoint))(int screen_x,
    int screen_y,
    char* infoOut,
    int infoOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(GetToggleCommandStateThroughHooks))(KbdSectionInfo* section,
    int command_id);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTouchedOrFocusedFX))(int mode,
    int* trackidxOut,
    int* itemidxOut,
    int* takeidxOut,
    int* fxidxOut,
...
TrackEnvelope* (* REAPERAPI_FUNCNAME(GetTrackEnvelopeByChunkName))(MediaTrack* tr,
    const char* cfgchunkname_or_guid);
#endif
...
TrackEnvelope* (* REAPERAPI_FUNCNAME(GetTrackEnvelopeByName))(MediaTrack* track,
    const char* envname);
#endif
...
MediaTrack* (* REAPERAPI_FUNCNAME(GetTrackFromPoint))(int screen_x,
    int screen_y,
    int* infoOutOptional);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackMIDILyrics))(MediaTrack* track,
    int flag,
    char* bufOutWantNeedBig,
    int* bufOutWantNeedBig_sz);
#endif
...
const char* (* REAPERAPI_FUNCNAME(GetTrackMIDINoteNameEx))(ReaProject* proj,
    MediaTrack* track,
    int pitch,
    int chan);
#endif
...
void (* REAPERAPI_FUNCNAME(GetTrackMIDINoteRange))(ReaProject* proj,
    MediaTrack* track,
    int* note_loOut,
    int* note_hiOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackReceiveName))(MediaTrack* track,
    int recv_index,
    char* bufOut,
    int bufOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackReceiveUIMute))(MediaTrack* track,
    int recv_index,
    bool* muteOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackReceiveUIVolPan))(MediaTrack* track,
    int recv_index,
    double* volumeOut,
    double* panOut);
#endif
...
double (* REAPERAPI_FUNCNAME(GetTrackSendInfo_Value))(MediaTrack* tr,
    int category,
    int sendidx,
    const char* parmname);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackSendName))(MediaTrack* track,
    int send_index,
    char* bufOut,
    int bufOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackSendUIVolPan))(MediaTrack* track,
    int send_index,
    double* volumeOut,
    double* panOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackStateChunk))(MediaTrack* track,
    char* strNeedBig,
    int strNeedBig_sz,
    bool isundoOptional);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetTrackUIPan))(MediaTrack* track,
    double* pan1Out,
    double* pan2Out,
    int* panmodeOut);
#endif
...
void (* REAPERAPI_FUNCNAME(GetUnderrunTime))(unsigned int* audio_xrunOut,
    unsigned int* media_xrunOut,
...
bool (* REAPERAPI_FUNCNAME(GetUserFileNameForRead))(char* filenameNeed4096,
    const char* title,
    const char* defext);
#endif
...
bool (* REAPERAPI_FUNCNAME(GetUserInputs))(const char* title,
    int num_inputs,
    const char* captions_csv,
    char* retvals_csv,
    int retvals_csv_sz);
#endif
...
void (* REAPERAPI_FUNCNAME(GoToMarker))(ReaProject* proj,
    int marker_index,
...
void (* REAPERAPI_FUNCNAME(GoToRegion))(ReaProject* proj,
    int region_index,
    bool use_timeline_order);
#endif
...
void (* REAPERAPI_FUNCNAME(HiresPeaksFromSource))(PCM_source* src,
...
int (* REAPERAPI_FUNCNAME(InsertAutomationItem))(TrackEnvelope* env,
    int pool_id,
    double position,
    double length);
#endif
...
bool (* REAPERAPI_FUNCNAME(InsertEnvelopePoint))(TrackEnvelope* envelope,
    double time,
    double value,
    int shape,
    double tension,
...
bool (* REAPERAPI_FUNCNAME(InsertEnvelopePointEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    double time,
    double value,
    int shape,
...
int (* REAPERAPI_FUNCNAME(InsertMediaSection))(const char* file,
    int mode,
    double startpct,
    double endpct,
    double pitchshift);
...
int (* REAPERAPI_FUNCNAME(joystick_getinfo))(joystick_device* dev,
    int* axesOutOptional,
    int* povsOutOptional);
#endif
...
int (* REAPERAPI_FUNCNAME(kbd_enumerateActions))(KbdSectionInfo* section,
    int idx,
    const char** nameOut);
#endif
...
int (* REAPERAPI_FUNCNAME(KBD_OnMainActionEx))(int cmd,
    int val,
    int valhw,
    int relmode,
    HWND hwnd,
...
bool (* REAPERAPI_FUNCNAME(kbd_processMidiEventActionEx))(MIDI_event_t* evt,
    KbdSectionInfo* section,
    HWND hwndCtx);
#endif
...
bool (* REAPERAPI_FUNCNAME(kbd_RunCommandThroughHooks))(KbdSectionInfo* section,
    const int* actionCommandID,
    const int* val,
    const int* valhw,
    const int* relmode,
    HWND hwnd);
...
int (* REAPERAPI_FUNCNAME(LICE__DrawText))(LICE_IFont* font,
    LICE_IBitmap* bm,
    const char* str,
    int strcnt,
    RECT* rect,
...
void (* REAPERAPI_FUNCNAME(LICE_Arc))(LICE_IBitmap* dest,
    float cx,
    float cy,
    float r,
    float minAngle,
...
void (* REAPERAPI_FUNCNAME(LICE_Blit))(LICE_IBitmap* dest,
    LICE_IBitmap* src,
    int dstx,
    int dsty,
    int srcx,
...
void (* REAPERAPI_FUNCNAME(LICE_Blur))(LICE_IBitmap* dest,
    LICE_IBitmap* src,
    int dstx,
    int dsty,
    int srcx,
...
void (* REAPERAPI_FUNCNAME(LICE_BorderedRect))(LICE_IBitmap* dest,
    int x,
    int y,
    int w,
    int h,
...
void (* REAPERAPI_FUNCNAME(LICE_Circle))(LICE_IBitmap* dest,
    float cx,
    float cy,
    float r,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_ClearRect))(LICE_IBitmap* dest,
    int x,
    int y,
    int w,
    int h,
...
bool (* REAPERAPI_FUNCNAME(LICE_ClipLine))(int* pX1Out,
    int* pY1Out,
    int* pX2Out,
    int* pY2Out,
    int xLo,
...
LICE_pixel (* REAPERAPI_FUNCNAME(LICE_CombinePixels))(LICE_pixel dest,
    LICE_pixel src,
    float alpha,
    int mode);
#endif
...
void (* REAPERAPI_FUNCNAME(LICE_DrawCBezier))(LICE_IBitmap* dest,
    double xstart,
    double ystart,
    double xctl1,
    double yctl1,
...
void (* REAPERAPI_FUNCNAME(LICE_DrawChar))(LICE_IBitmap* bm,
    int x,
    int y,
    char c,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_DrawGlyph))(LICE_IBitmap* dest,
    int x,
    int y,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_DrawRect))(LICE_IBitmap* dest,
    int x,
    int y,
    int w,
    int h,
...
void (* REAPERAPI_FUNCNAME(LICE_DrawText))(LICE_IBitmap* bm,
    int x,
    int y,
    const char* string,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_FillCBezier))(LICE_IBitmap* dest,
    double xstart,
    double ystart,
    double xctl1,
    double yctl1,
...
void (* REAPERAPI_FUNCNAME(LICE_FillCircle))(LICE_IBitmap* dest,
    float cx,
    float cy,
    float r,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_FillConvexPolygon))(LICE_IBitmap* dest,
    int* x,
    int* y,
    int npoints,
    LICE_pixel color,
...
void (* REAPERAPI_FUNCNAME(LICE_FillRect))(LICE_IBitmap* dest,
    int x,
    int y,
    int w,
    int h,
...
void (* REAPERAPI_FUNCNAME(LICE_FillTrapezoid))(LICE_IBitmap* dest,
    int x1a,
    int x1b,
    int y1,
    int x2a,
...
void (* REAPERAPI_FUNCNAME(LICE_FillTriangle))(LICE_IBitmap* dest,
    int x1,
    int y1,
    int x2,
    int y2,
...
void (* REAPERAPI_FUNCNAME(LICE_GradRect))(LICE_IBitmap* dest,
    int dstx,
    int dsty,
    int dstw,
    int dsth,
...
void (* REAPERAPI_FUNCNAME(LICE_Line))(LICE_IBitmap* dest,
    float x1,
    float y1,
    float x2,
    float y2,
...
void (* REAPERAPI_FUNCNAME(LICE_LineInt))(LICE_IBitmap* dest,
    int x1,
    int y1,
    int x2,
    int y2,
...
LICE_IBitmap* (* REAPERAPI_FUNCNAME(LICE_LoadPNGFromResource))(HINSTANCE hInst,
    const char* resid,
    LICE_IBitmap* bmp);
#endif
...
void (* REAPERAPI_FUNCNAME(LICE_MultiplyAddRect))(LICE_IBitmap* dest,
    int x,
    int y,
    int w,
    int h,
...
void (* REAPERAPI_FUNCNAME(LICE_PutPixel))(LICE_IBitmap* bm,
    int x,
    int y,
    LICE_pixel color,
    float alpha,
...
void (* REAPERAPI_FUNCNAME(LICE_RotatedBlit))(LICE_IBitmap* dest,
    LICE_IBitmap* src,
    int dstx,
    int dsty,
    int dstw,
...
void (* REAPERAPI_FUNCNAME(LICE_RoundRect))(LICE_IBitmap* drawbm,
    float xpos,
    float ypos,
    float w,
    float h,
...
void (* REAPERAPI_FUNCNAME(LICE_ScaledBlit))(LICE_IBitmap* dest,
    LICE_IBitmap* src,
    int dstx,
    int dsty,
    int dstw,
...
void (* REAPERAPI_FUNCNAME(LICE_SimpleFill))(LICE_IBitmap* dest,
    int x,
    int y,
    LICE_pixel newcolor,
...
void (* REAPERAPI_FUNCNAME(LICE_ThickFLine))(LICE_IBitmap* dest,
    double x1,
    double y1,
    double x2,
    double y2,
...
const char* (* REAPERAPI_FUNCNAME(LocalizeString))(const char* src_string,
    const char* section,
    int flagsOptional);
#endif
...
void (* REAPERAPI_FUNCNAME(Main_SaveProjectEx))(ReaProject* proj,
    const char* filename,
    int options);
#endif
...
bool (* REAPERAPI_FUNCNAME(Menu_GetHash))(const char* menuname,
    int flag,
    char* hashOut,
    int hashOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(MIDI_CountEvts))(MediaItem_Take* take,
    int* notecntOut,
    int* ccevtcntOut,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetAllEvts))(MediaItem_Take* take,
    char* bufOutNeedBig,
    int* bufOutNeedBig_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetCC))(MediaItem_Take* take,
    int ccidx,
    bool* selectedOut,
    bool* mutedOut,
    double* ppqposOut,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetCCShape))(MediaItem_Take* take,
    int ccidx,
    int* shapeOut,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetEvt))(MediaItem_Take* take,
    int evtidx,
    bool* selectedOut,
    bool* mutedOut,
    double* ppqposOut,
...
double (* REAPERAPI_FUNCNAME(MIDI_GetGrid))(MediaItem_Take* take,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetHash))(MediaItem_Take* take,
    bool notesonly,
    char* hashOut,
    int hashOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetNote))(MediaItem_Take* take,
    int noteidx,
    bool* selectedOut,
    bool* mutedOut,
...
int (* REAPERAPI_FUNCNAME(MIDI_GetRecentInputEvent))(int idx,
    char* bufOut,
    int* bufOut_sz,
    int* tsOut,
    int* devIdxOut,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetScale))(MediaItem_Take* take,
    int* rootOut,
    int* scaleOut,
    char* nameOut,
    int nameOut_sz);
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetTextSysexEvt))(MediaItem_Take* take,
    int textsyxevtidx,
...
bool (* REAPERAPI_FUNCNAME(MIDI_GetTrackHash))(MediaTrack* track,
    bool notesonly,
    char* hashOut,
    int hashOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDI_InsertCC))(MediaItem_Take* take,
    bool selected,
    bool muted,
    double ppqpos,
    int chanmsg,
...
bool (* REAPERAPI_FUNCNAME(MIDI_InsertEvt))(MediaItem_Take* take,
    bool selected,
    bool muted,
    double ppqpos,
    const char* bytestr,
...
bool (* REAPERAPI_FUNCNAME(MIDI_InsertNote))(MediaItem_Take* take,
    bool selected,
    bool muted,
    double startppqpos,
    double endppqpos,
...
bool (* REAPERAPI_FUNCNAME(MIDI_InsertTextSysexEvt))(MediaItem_Take* take,
    bool selected,
    bool muted,
    double ppqpos,
    int type,
...
bool (* REAPERAPI_FUNCNAME(MIDI_SetCC))(MediaItem_Take* take,
    int ccidx,
    const bool* selectedInOptional,
    const bool* mutedInOptional,
    const double* ppqposInOptional,
    const int* chanmsgInOptional,
    const int* chanInOptional,
    const int* msg2InOptional,
    const int* msg3InOptional,
    const bool* noSortInOptional);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDI_SetCCShape))(MediaItem_Take* take,
    int ccidx,
    int shape,
    double beztension,
    const bool* noSortInOptional);
...
bool (* REAPERAPI_FUNCNAME(MIDI_SetEvt))(MediaItem_Take* take,
    int evtidx,
    const bool* selectedInOptional,
    const bool* mutedInOptional,
    const double* ppqposInOptional,
    const char* msgOptional,
    int msgOptional_sz,
    const bool* noSortInOptional);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDI_SetNote))(MediaItem_Take* take,
    int noteidx,
    const bool* selectedInOptional,
    const bool* mutedInOptional,
...
bool (* REAPERAPI_FUNCNAME(MIDI_SetTextSysexEvt))(MediaItem_Take* take,
    int textsyxevtidx,
    const bool* selectedInOptional,
    const bool* mutedInOptional,
    const double* ppqposInOptional,
...
MediaItem_Take* (* REAPERAPI_FUNCNAME(MIDIEditor_EnumTakes))(HWND midieditor,
    int takeindex,
    bool editable_only);
#endif
...
bool (* REAPERAPI_FUNCNAME(MIDIEditor_GetSetting_str))(HWND midieditor,
...
bool (* REAPERAPI_FUNCNAME(MIDIEditor_LastFocused_OnCommand))(int command_id,
...
bool (* REAPERAPI_FUNCNAME(MIDIEditor_SetSetting_int))(HWND midieditor,
    const char* setting_desc,
    int setting);
#endif
...
void (* REAPERAPI_FUNCNAME(MIDIEditorFlagsForTrack))(MediaTrack* track,
    int* pitchwheelrangeInOut,
    int* flagsInOut,
    bool is_set);
#endif
...
void (* REAPERAPI_FUNCNAME(OscLocalMessageToHost))(const char* message,
...
PCM_sink* (* REAPERAPI_FUNCNAME(PCM_Sink_Create))(const char* filename,
    const char* cfg,
    int cfg_sz,
    int nch,
    int srate,
...
PCM_sink* (* REAPERAPI_FUNCNAME(PCM_Sink_CreateEx))(ReaProject* proj,
    const char* filename,
    const char* cfg,
    int cfg_sz,
    int nch,
...
PCM_sink* (* REAPERAPI_FUNCNAME(PCM_Sink_CreateMIDIFile))(const char* filename,
    const char* cfg,
    int cfg_sz,
    double bpm,
    int div);
...
PCM_sink* (* REAPERAPI_FUNCNAME(PCM_Sink_CreateMIDIFileEx))(ReaProject* proj,
    const char* filename,
    const char* cfg,
    int cfg_sz,
    double bpm,
...
PCM_source* (* REAPERAPI_FUNCNAME(PCM_Source_CreateFromFileEx))(const char* filename,
    bool forcenoMidiImp);
#endif
...
PCM_source* (* REAPERAPI_FUNCNAME(PCM_Source_CreateFromSimple))(ISimpleMediaDecoder* dec,
    const char* fn);
#endif
...
int (* REAPERAPI_FUNCNAME(PCM_Source_GetPeaks))(PCM_source* src,
    double peakrate,
    double starttime,
    int numchannels,
    int numsamplesperchannel,
...
bool (* REAPERAPI_FUNCNAME(PCM_Source_GetSectionInfo))(PCM_source* src,
    double* offsOut,
    double* lenOut,
    bool* revOut);
#endif
...
REAPER_PeakBuild_Interface* (* REAPERAPI_FUNCNAME(PeakBuild_Create))(PCM_source* src,
    const char* fn,
    int srate,
    int nch);
#endif
...
REAPER_PeakBuild_Interface* (* REAPERAPI_FUNCNAME(PeakBuild_CreateEx))(PCM_source* src,
    const char* fn,
    int srate,
    int nch,
    int flags);
...
REAPER_PeakGet_Interface* (* REAPERAPI_FUNCNAME(PeakGet_Create))(const char* fn,
    int srate,
    int nch);
#endif
...
int (* REAPERAPI_FUNCNAME(PitchShiftSubModeMenu))(HWND hwnd,
    int x,
    int y,
    int mode,
    int submode_sel);
...
int (* REAPERAPI_FUNCNAME(PlayPreviewEx))(preview_register_t* preview,
    int bufflags,
...
int (* REAPERAPI_FUNCNAME(PlayTrackPreview2Ex))(ReaProject* proj,
...
bool (* REAPERAPI_FUNCNAME(RenderFileSection))(const char* source_filename,
...
void (* REAPERAPI_FUNCNAME(resolve_fn2))(const char* in,
    char* out,
    int out_sz,
...
int (* REAPERAPI_FUNCNAME(ResolveRenderPattern))(ReaProject* project,
    const char* path,
    const char* pattern,
    char* targets,
    int targets_sz);
...
void (* REAPERAPI_FUNCNAME(screenset_registerNew))(char* id,
...
void (* REAPERAPI_FUNCNAME(SendLocalOscMessage))(void* local_osc_handler,
    const char* msg,
    int msglen);
#endif
...
void (* REAPERAPI_FUNCNAME(SetEditCurPos2))(ReaProject* proj,
    double time,
    bool moveview,
    bool seekplay);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetEnvelopePoint))(TrackEnvelope* envelope,
    int ptidx,
    double* timeInOptional,
...
bool (* REAPERAPI_FUNCNAME(SetEnvelopePointEx))(TrackEnvelope* envelope,
    int autoitem_idx,
    int ptidx,
    double* timeInOptional,
    double* valueInOptional,
...
bool (* REAPERAPI_FUNCNAME(SetEnvelopeStateChunk))(TrackEnvelope* env,
    const char* str,
    bool isundoOptional);
#endif
...
void (* REAPERAPI_FUNCNAME(SetExtState))(const char* section,
    const char* key,
    const char* value,
    bool persist);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetItemStateChunk))(MediaItem* item,
    const char* str,
    bool isundoOptional);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetMediaItemInfo_Value))(MediaItem* item,
    const char* parmname,
    double newvalue);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetMediaItemTakeInfo_Value))(MediaItem_Take* take,
    const char* parmname,
    double newvalue);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetMediaTrackInfo_Value))(MediaTrack* tr,
    const char* parmname,
    double newvalue);
#endif
...
void (* REAPERAPI_FUNCNAME(SetMouseModifier))(const char* context,
    int modifier_flag,
    const char* action);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarker))(int markrgnindexnumber,
    bool isrgn,
    double pos,
    double rgnend,
    const char* name);
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarker2))(ReaProject* proj,
    int markrgnindexnumber,
    bool isrgn,
    double pos,
    double rgnend,
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarker3))(ReaProject* proj,
    int markrgnindexnumber,
    bool isrgn,
    double pos,
    double rgnend,
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarker4))(ReaProject* proj,
    int markrgnindexnumber,
    bool isrgn,
    double pos,
    double rgnend,
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarkerByIndex))(ReaProject* proj,
    int markrgnidx,
    bool isrgn,
    double pos,
    double rgnend,
...
bool (* REAPERAPI_FUNCNAME(SetProjectMarkerByIndex2))(ReaProject* proj,
    int markrgnidx,
    bool isrgn,
    double pos,
    double rgnend,
...
int (* REAPERAPI_FUNCNAME(SetProjExtState))(ReaProject* proj,
    const char* extname,
    const char* key,
    const char* value);
#endif
...
void (* REAPERAPI_FUNCNAME(SetRegionRenderMatrix))(ReaProject* proj,
    int regionindex,
    MediaTrack* track,
    int flag);
#endif
...
int (* REAPERAPI_FUNCNAME(SetTakeMarker))(MediaItem_Take* take,
    int idx,
    const char* nameIn,
...
int (* REAPERAPI_FUNCNAME(SetTakeStretchMarker))(MediaItem_Take* take,
    int idx,
    double pos,
...
bool (* REAPERAPI_FUNCNAME(SetTempoTimeSigMarker))(ReaProject* proj,
    int ptidx,
    double timepos,
    int measurepos,
    double beatpos,
...
bool (* REAPERAPI_FUNCNAME(SetTrackMIDINoteNameEx))(ReaProject* proj,
    MediaTrack* track,
    int pitch,
    int chan,
    const char* name);
...
bool (* REAPERAPI_FUNCNAME(SetTrackSendInfo_Value))(MediaTrack* tr,
    int category,
    int sendidx,
    const char* parmname,
    double newvalue);
...
bool (* REAPERAPI_FUNCNAME(SetTrackSendUIPan))(MediaTrack* track,
    int send_idx,
    double pan,
    int isend);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetTrackSendUIVol))(MediaTrack* track,
    int send_idx,
    double vol,
    int isend);
#endif
...
bool (* REAPERAPI_FUNCNAME(SetTrackStateChunk))(MediaTrack* track,
    const char* str,
    bool isundoOptional);
#endif
...
int (* REAPERAPI_FUNCNAME(SetTrackUIInputMonitor))(MediaTrack* track,
    int monitor,
    int igngroupflags);
#endif
...
double (* REAPERAPI_FUNCNAME(SetTrackUIPan))(MediaTrack* track,
    double pan,
    bool relative,
    bool done,
    int igngroupflags);
...
double (* REAPERAPI_FUNCNAME(SetTrackUIVolume))(MediaTrack* track,
    double volume,
    bool relative,
    bool done,
    int igngroupflags);
...
double (* REAPERAPI_FUNCNAME(SetTrackUIWidth))(MediaTrack* track,
    double width,
    bool relative,
    bool done,
    int igngroupflags);
...
void (* REAPERAPI_FUNCNAME(ShowPopupMenu))(const char* name,
    int x,
    int y,
    HWND hwndParentOptional,
    void* ctxOptional,
    int ctx2Optional,
    int ctx3Optional);
#endif
...
int (* REAPERAPI_FUNCNAME(TakeFX_AddByName))(MediaItem_Take* take,
    const char* fxname,
    int instantiate);
#endif
...
void (* REAPERAPI_FUNCNAME(TakeFX_CopyToTake))(MediaItem_Take* src_take,
    int src_fx,
...
void (* REAPERAPI_FUNCNAME(TakeFX_CopyToTrack))(MediaItem_Take* src_take,
    int src_fx,
...
bool (* REAPERAPI_FUNCNAME(TakeFX_FormatParamValue))(MediaItem_Take* take,
    int fx,
    int param,
    double val,
    char* bufOut,
...
bool (* REAPERAPI_FUNCNAME(TakeFX_FormatParamValueNormalized))(MediaItem_Take* take,
    int fx,
    int param,
    double value,
    char* buf,
...
TrackEnvelope* (* REAPERAPI_FUNCNAME(TakeFX_GetEnvelope))(MediaItem_Take* take,
    int fxindex,
    int parameterindex,
    bool create);
#endif
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetFormattedParamValue))(MediaItem_Take* take,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetFXName))(MediaItem_Take* take,
    int fx,
    char* bufOut,
    int bufOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(TakeFX_GetIOSize))(MediaItem_Take* take,
    int fx,
    int* inputPinsOut,
    int* outputPinsOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetNamedConfigParm))(MediaItem_Take* take,
    int fx,
    const char* parmname,
    char* bufOutNeedBig,
    int bufOutNeedBig_sz);
...
double (* REAPERAPI_FUNCNAME(TakeFX_GetParam))(MediaItem_Take* take,
    int fx,
    int param,
    double* minvalOut,
    double* maxvalOut);
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetParameterStepSizes))(MediaItem_Take* take,
    int fx,
    int param,
    double* stepOut,
    double* smallstepOut,
...
double (* REAPERAPI_FUNCNAME(TakeFX_GetParamEx))(MediaItem_Take* take,
    int fx,
    int param,
    double* minvalOut,
    double* maxvalOut,
...
int (* REAPERAPI_FUNCNAME(TakeFX_GetParamFromIdent))(MediaItem_Take* take,
    int fx,
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetParamIdent))(MediaItem_Take* take,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetParamName))(MediaItem_Take* take,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
int (* REAPERAPI_FUNCNAME(TakeFX_GetPinMappings))(MediaItem_Take* take,
    int fx,
    int isoutput,
    int pin,
    int* high32Out);
...
bool (* REAPERAPI_FUNCNAME(TakeFX_GetPreset))(MediaItem_Take* take,
    int fx,
    char* presetnameOut,
    int presetnameOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(TakeFX_GetPresetIndex))(MediaItem_Take* take,
    int fx,
...
void (* REAPERAPI_FUNCNAME(TakeFX_GetUserPresetFilename))(MediaItem_Take* take,
    int fx,
    char* fnOut,
    int fnOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(TakeFX_SetNamedConfigParm))(MediaItem_Take* take,
    int fx,
    const char* parmname,
    const char* value);
#endif
...
bool (* REAPERAPI_FUNCNAME(TakeFX_SetParamNormalized))(MediaItem_Take* take,
    int fx,
    int param,
    double value);
#endif
...
bool (* REAPERAPI_FUNCNAME(TakeFX_SetPinMappings))(MediaItem_Take* take,
    int fx,
    int isoutput,
    int pin,
    int low32bits,
...
bool (* REAPERAPI_FUNCNAME(ThemeLayout_GetLayout))(const char* section,
    int idx,
    char* nameOut,
    int nameOut_sz);
#endif
...
const char* (* REAPERAPI_FUNCNAME(ThemeLayout_GetParameter))(int wp,
    const char** descOutOptional,
...
double (* REAPERAPI_FUNCNAME(TimeMap2_beatsToTime))(ReaProject* proj,
    double tpos,
...
double (* REAPERAPI_FUNCNAME(TimeMap2_timeToBeats))(ReaProject* proj,
    double tpos,
...
double (* REAPERAPI_FUNCNAME(TimeMap_GetMeasureInfo))(ReaProject* proj,
    int measure,
    double* qn_startOut,
    double* qn_endOut,
    int* timesig_numOut,
...
int (* REAPERAPI_FUNCNAME(TimeMap_GetMetronomePattern))(ReaProject* proj,
    double time,
    char* pattern,
    int pattern_sz);
#endif
...
void (* REAPERAPI_FUNCNAME(TimeMap_GetTimeSigAtTime))(ReaProject* proj,
    double time,
    int* timesig_numOut,
    int* timesig_denomOut,
    double* tempoOut);
...
int (* REAPERAPI_FUNCNAME(TimeMap_QNToMeasures))(ReaProject* proj,
    double qn,
...
int (* REAPERAPI_FUNCNAME(TrackFX_AddByName))(MediaTrack* track,
    const char* fxname,
    bool recFX,
    int instantiate);
#endif
...
void (* REAPERAPI_FUNCNAME(TrackFX_CopyToTake))(MediaTrack* src_track,
    int src_fx,
    MediaItem_Take* dest_take,
    int dest_fx,
    bool is_move);
...
void (* REAPERAPI_FUNCNAME(TrackFX_CopyToTrack))(MediaTrack* src_track,
    int src_fx,
    MediaTrack* dest_track,
    int dest_fx,
    bool is_move);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_FormatParamValue))(MediaTrack* track,
    int fx,
    int param,
    double val,
    char* bufOut,
...
bool (* REAPERAPI_FUNCNAME(TrackFX_FormatParamValueNormalized))(MediaTrack* track,
    int fx,
    int param,
    double value,
    char* buf,
...
int (* REAPERAPI_FUNCNAME(TrackFX_GetByName))(MediaTrack* track,
    const char* fxname,
    bool instantiate);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetEQBandEnabled))(MediaTrack* track,
    int fxidx,
    int bandtype,
    int bandidx);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetEQParam))(MediaTrack* track,
    int fxidx,
    int paramidx,
    int* bandtypeOut,
    int* bandidxOut,
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetFormattedParamValue))(MediaTrack* track,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetFXName))(MediaTrack* track,
    int fx,
    char* bufOut,
    int bufOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(TrackFX_GetIOSize))(MediaTrack* track,
    int fx,
    int* inputPinsOut,
    int* outputPinsOut);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetNamedConfigParm))(MediaTrack* track,
    int fx,
    const char* parmname,
    char* bufOutNeedBig,
    int bufOutNeedBig_sz);
...
double (* REAPERAPI_FUNCNAME(TrackFX_GetParam))(MediaTrack* track,
    int fx,
    int param,
    double* minvalOut,
    double* maxvalOut);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetParameterStepSizes))(MediaTrack* track,
    int fx,
    int param,
    double* stepOut,
    double* smallstepOut,
...
double (* REAPERAPI_FUNCNAME(TrackFX_GetParamEx))(MediaTrack* track,
    int fx,
    int param,
    double* minvalOut,
    double* maxvalOut,
...
int (* REAPERAPI_FUNCNAME(TrackFX_GetParamFromIdent))(MediaTrack* track,
    int fx,
    const char* ident_str);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetParamIdent))(MediaTrack* track,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetParamName))(MediaTrack* track,
    int fx,
    int param,
    char* bufOut,
    int bufOut_sz);
...
int (* REAPERAPI_FUNCNAME(TrackFX_GetPinMappings))(MediaTrack* tr,
    int fx,
    int isoutput,
    int pin,
    int* high32Out);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_GetPreset))(MediaTrack* track,
    int fx,
    char* presetnameOut,
    int presetnameOut_sz);
#endif
...
int (* REAPERAPI_FUNCNAME(TrackFX_GetPresetIndex))(MediaTrack* track,
    int fx,
    int* numberOfPresetsOut);
#endif
...
void (* REAPERAPI_FUNCNAME(TrackFX_GetUserPresetFilename))(MediaTrack* track,
    int fx,
    char* fnOut,
    int fnOut_sz);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_SetEQBandEnabled))(MediaTrack* track,
    int fxidx,
    int bandtype,
    int bandidx,
    bool enable);
...
bool (* REAPERAPI_FUNCNAME(TrackFX_SetEQParam))(MediaTrack* track,
    int fxidx,
    int bandtype,
    int bandidx,
    int paramtype,
...
bool (* REAPERAPI_FUNCNAME(TrackFX_SetNamedConfigParm))(MediaTrack* track,
    int fx,
    const char* parmname,
    const char* value);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_SetParamNormalized))(MediaTrack* track,
    int fx,
    int param,
    double value);
#endif
...
bool (* REAPERAPI_FUNCNAME(TrackFX_SetPinMappings))(MediaTrack* tr,
    int fx,
    int isoutput,
    int pin,
    int low32bits,
...
void (* REAPERAPI_FUNCNAME(Undo_EndBlock2))(ReaProject* proj,
...
void (* REAPERAPI_FUNCNAME(Undo_OnStateChange_Item))(ReaProject* proj,
    const char* name,
    MediaItem* item);
#endif
...
void (* REAPERAPI_FUNCNAME(Undo_OnStateChangeEx))(const char* descchange,
    int whichStates,
    int trackparm);
#endif
...
void (* REAPERAPI_FUNCNAME(Undo_OnStateChangeEx2))(ReaProject* proj,
    const char* descchange,
    int whichStates,
    int trackparm);
#endif
...
bool (* REAPERAPI_FUNCNAME(WDL_VirtualWnd_ScaledBlitBG))(LICE_IBitmap* dest,
