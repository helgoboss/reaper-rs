...
// Generated by REAPER v6.37rc11/win64
...
// I_VUMODE : int * : track vu mode, &1=disabled, 0=stereo peaks, 2=multichannel peaks, 4=stereo RMS, 8=combined RMS, 12=LUFS-M, 16=LUFS-S (readout=max), 20=LUFS-S (readout=current)
...
// RENDER_NORMALIZE: &1=enable, (&14==0)=LUFS-I, (&14==2)=RMS, (&14==4)=peak, (&14==6)=true peak, (&14==8)=LUFS-M max, (&14==10)=LUFS-S max, &32=normalize stems to common gain based on master, &64=enable brickwall limit
