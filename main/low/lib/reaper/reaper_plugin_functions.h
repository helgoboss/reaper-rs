...
// Generated by REAPER v6.11+dev0609/x64
...
// PAN_REVERSE
// WIDTH_REVERSE
// NO_MASTER_WHEN_FOLLOW
// VOLUME_VCA_FOLLOW_ISPREFX
// 
// Note: REAPER v6.11 and earlier used _SLAVE rather than _FOLLOW, which is deprecated but still supported (scripts that must support v6.11 and earlier can use the deprecated string).
// 
