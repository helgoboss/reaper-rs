...
pub use super::bindings::root::{
    ...
    MediaItem_Take, MediaTrack, PCM_source, PCM_source_peaktransfer_t, PCM_source_transfer_t,
    ProjectStateContext, REAPER_Resample_Interface, ReaProject, ReaSample, TrackEnvelope,
    ...
    PCM_SOURCE_EXT_OPENEDITOR, REAPER_PITCHSHIFT_API_VER, REAPER_PLUGIN_VERSION, UNDO_STATE_ALL,
