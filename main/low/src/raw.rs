...
pub use super::bindings::root::{
    ...
    TrackEnvelope, CSURF_EXT_RESET, CSURF_EXT_SETBPMANDPLAYRATE, CSURF_EXT_SETFOCUSEDFX,
    ...
    CSURF_EXT_SUPPORTS_EXTENDED_TOUCH, CSURF_EXT_TRACKFX_PRESET_CHANGED, REAPER_PLUGIN_VERSION,
