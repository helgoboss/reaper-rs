...
pub use super::bindings::root::{
    ...
    CSURF_EXT_TRACKFX_PRESET_CHANGED, IReaperControlSurface, IReaperPitchShift, KbdCmd,
    KbdSectionInfo, LN10_OVER_TWENTY, MIDI_event_t, MIDI_eventlist, MediaItem, MediaItem_Take,
    MediaTrack, PCM_SOURCE_EXT_EXPORTTOFILE, PCM_SOURCE_EXT_GETHASH,
    PCM_SOURCE_EXT_GETPOOLEDMIDIID, PCM_SOURCE_EXT_OPENEDITOR, PCM_SOURCE_EXT_SETPREVIEWTEMPO,
    PCM_sink, PCM_source, PCM_source_peaktransfer_t, PCM_source_transfer_t, ProjectStateContext,
    REAPER_PITCHSHIFT_API_VER, REAPER_PLUGIN_VERSION, REAPER_Resample_Interface,
    RESAMPLE_EXT_SETRSMODE, ReaProject, ReaSample, TWENTY_OVER_LN10, TrackEnvelope, UNDO_STATE_ALL,
    UNDO_STATE_FREEZE, UNDO_STATE_FX, UNDO_STATE_ITEMS, UNDO_STATE_MISCCFG, UNDO_STATE_TRACKCFG,
    WDL_HeapBuf, accelerator_register_t, audio_hook_register_t, gaccel_register_t, midi_Input,
    midi_Output, midi_realtime_write_struct_t, preview_register_t, reaper_plugin_info_t,
};
...
pub use super::bindings::root::{
    ACCEL, BM_GETCHECK, BM_GETIMAGE, BM_SETCHECK, BM_SETIMAGE, BOOL, BST_CHECKED,
    BST_INDETERMINATE, BST_UNCHECKED, CB_ADDSTRING, CB_DELETESTRING, CB_FINDSTRING,
    CB_FINDSTRINGEXACT, CB_GETCOUNT, CB_GETCURSEL, CB_GETITEMDATA, CB_GETLBTEXT, CB_GETLBTEXTLEN,
    CB_INITSTORAGE, CB_INSERTSTRING, CB_RESETCONTENT, CB_SETCURSEL, CB_SETITEMDATA, CBN_CLOSEUP,
    CBN_DROPDOWN, CBN_EDITCHANGE, CBN_SELCHANGE, COLOR_3DDKSHADOW, COLOR_3DFACE, COLOR_3DHILIGHT,
    ...
    GMEM_FIXED, GMEM_LOWER, GMEM_MOVEABLE, GMEM_SHARE, GMEM_ZEROINIT, GUID, GW_CHILD, GW_HWNDFIRST,
    GW_HWNDLAST, GW_HWNDNEXT, GW_HWNDPREV, GW_OWNER, GWL_EXSTYLE, GWL_HWNDPARENT, GWL_ID,
    GWL_STYLE, GWL_WNDPROC, HANDLE, HBRUSH, HDC, HDC__, HFONT, HGDIOBJ__, HINSTANCE, HMENU,
    ...
    SRCCOPY, SRCCOPY_USEALPHACHAN, THREAD_BASE_PRIORITY_IDLE, THREAD_BASE_PRIORITY_LOWRT,
    THREAD_BASE_PRIORITY_MAX, THREAD_BASE_PRIORITY_MIN, THREAD_PRIORITY_ABOVE_NORMAL,
    THREAD_PRIORITY_BELOW_NORMAL, THREAD_PRIORITY_HIGHEST, THREAD_PRIORITY_IDLE,
    THREAD_PRIORITY_LOWEST, THREAD_PRIORITY_NORMAL, THREAD_PRIORITY_TIME_CRITICAL, TPM_BOTTOMALIGN,
    TPM_CENTERALIGN, TPM_HORIZONTAL, TPM_LEFTALIGN, TPM_LEFTBUTTON, TPM_NONOTIFY, TPM_RETURNCMD,
    TPM_RIGHTALIGN, TPM_RIGHTBUTTON, TPM_TOPALIGN, TPM_VCENTERALIGN, TPM_VERTICAL, UINT, ULONG_PTR,
    VK_ADD, VK_BACK, VK_CAPITAL, VK_CLEAR, VK_CONTROL, VK_DECIMAL, VK_DELETE, VK_DIVIDE, VK_DOWN,
    ...
    VK_F23, VK_F24, VK_HELP, VK_HOME, VK_INSERT, VK_LBUTTON, VK_LEFT, VK_LWIN, VK_MBUTTON, VK_MENU,
    ...
    VK_RBUTTON, VK_RETURN, VK_RIGHT, VK_SCROLL, VK_SELECT, VK_SEPARATOR, VK_SHIFT, VK_SNAPSHOT,
    VK_SPACE, VK_SUBTRACT, VK_TAB, VK_UP, WDL_INT64, WM_ACTIVATE, WM_ACTIVATEAPP,
    WM_CAPTURECHANGED, WM_CHAR, WM_CLOSE, WM_COMMAND, WM_CONTEXTMENU, WM_COPYDATA, WM_CREATE,
    WM_CTLCOLORBTN, WM_CTLCOLORDLG, WM_CTLCOLOREDIT, WM_CTLCOLORLISTBOX, WM_CTLCOLORMSGBOX,
    WM_CTLCOLORSCROLLBAR, WM_CTLCOLORSTATIC, WM_DEADCHAR, WM_DESTROY, WM_DISPLAYCHANGE,
    ...
    WM_PAINT, WM_RBUTTONDBLCLK, WM_RBUTTONDOWN, WM_RBUTTONUP, WM_SETCURSOR, WM_SETFOCUS,
    WM_SETFONT, WM_SETREDRAW, WM_SETTEXT, WM_SHOWWINDOW, WM_SIZE, WM_STYLECHANGED, WM_SYSCHAR,
    WM_SYSCOMMAND, WM_SYSDEADCHAR, WM_SYSKEYDOWN, WM_SYSKEYUP, WM_TIMER, WM_USER, WM_VSCROLL,
    WPARAM, WS_CAPTION, WS_SYSMENU, WS_THICKFRAME, midi_quantize_mode_t,
};
...
/// Function pointer type for toolbar icon maps.
