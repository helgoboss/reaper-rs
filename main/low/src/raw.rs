...
pub use super::bindings::root::{
    ...
    GMEM_FIXED, GMEM_LOWER, GMEM_MOVEABLE, GMEM_SHARE, GMEM_ZEROINIT, GUID, GW_CHILD, HANDLE,
    HBRUSH, HDC, HDC__, HGDIOBJ__, HINSTANCE, HMENU, HMENU__, HWND, HWND__, IDABORT, IDCANCEL,
    IDIGNORE, IDNO, IDOK, IDRETRY, IDYES, INT_PTR, LPARAM, LPSTR, LRESULT, MB_ICONERROR,
