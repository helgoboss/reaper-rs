...
pub use super::bindings::root::{
    ...
    REAPER_PITCHSHIFT_API_VER, REAPER_PLUGIN_VERSION, UNDO_STATE_ALL, UNDO_STATE_FREEZE,
...
pub use super::bindings::root::{
    ...
    MF_UNCHECKED, MIIM_BITMAP, OPAQUE, PAINTSTRUCT, PCM_SOURCE_EXT_REMOVEFROMMIDIPOOL, POINT, RECT,
    SB_BOTH, SB_BOTTOM, SB_CTL, SB_ENDSCROLL, SB_HORZ, SB_LEFT, SB_LINEDOWN, SB_LINELEFT,
    SB_LINERIGHT, SB_LINEUP, SB_PAGEDOWN, SB_PAGELEFT, SB_PAGERIGHT, SB_PAGEUP, SB_RIGHT,
    SB_THUMBPOSITION, SB_THUMBTRACK, SB_TOP, SB_VERT, SCROLLINFO, SIF_ALL, SIF_DISABLENOSCROLL,
    SIF_PAGE, SIF_POS, SIF_RANGE, SIF_TRACKPOS, SRCCOPY, SRCCOPY_USEALPHACHAN, TPM_BOTTOMALIGN,
    TPM_CENTERALIGN, TPM_HORIZONTAL, TPM_LEFTALIGN, TPM_LEFTBUTTON, TPM_NONOTIFY, TPM_RETURNCMD,
    TPM_RIGHTALIGN, TPM_RIGHTBUTTON, TPM_TOPALIGN, TPM_VCENTERALIGN, TPM_VERTICAL, TRANSPARENT,
    UINT, ULONG_PTR, VK_CONTROL, VK_LBUTTON, VK_MBUTTON, VK_MENU, VK_RBUTTON, VK_SHIFT, WDL_INT64,
    WM_ACTIVATE, WM_ACTIVATEAPP, WM_CAPTURECHANGED, WM_CHAR, WM_CLOSE, WM_COMMAND, WM_CONTEXTMENU,
    WM_COPYDATA, WM_CREATE, WM_CTLCOLORBTN, WM_CTLCOLORDLG, WM_CTLCOLOREDIT, WM_CTLCOLORLISTBOX,
    WM_CTLCOLORMSGBOX, WM_CTLCOLORSCROLLBAR, WM_CTLCOLORSTATIC, WM_DEADCHAR, WM_DESTROY,
