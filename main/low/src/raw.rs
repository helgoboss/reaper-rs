...
pub use super::bindings::root::{
    ...
    HBRUSH, HDC, HDC__, HINSTANCE, HMENU, HMENU__, HWND, HWND__, IDABORT, IDCANCEL, IDIGNORE, IDNO,
    IDOK, IDRETRY, IDYES, INT_PTR, LPARAM, LPSTR, LRESULT, MB_ICONERROR, MB_ICONINFORMATION,
    ...
    MF_POPUP, MF_SEPARATOR, MF_STRING, MF_UNCHECKED, MIIM_BITMAP, MSG, OPAQUE, PAINTSTRUCT,
