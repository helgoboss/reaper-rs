...
pub use super::bindings::root::{
    ...
    REAPER_PITCHSHIFT_API_VER, REAPER_PLUGIN_VERSION, RESAMPLE_EXT_SETRSMODE, UNDO_STATE_ALL,
...
pub use super::bindings::root::{
    ...
    MF_UNCHECKED, MIIM_BITMAP, OPAQUE, PAINTSTRUCT, PCM_SINK_EXT_CREATESOURCE,
