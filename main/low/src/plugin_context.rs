...
/// [`static_vst_plugin_context()`] which is generated by the [`reaper_vst_plugin`]
/// macro.
///
...
/// Contains those parts of the REAPER extension plug-in context which must be obtained from
/// static variables.
///
