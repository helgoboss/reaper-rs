...
impl Reaper {
    ...
    pub fn load(plugin_context: PluginContext) -> Reaper {
        ...
        let mut pointers = unsafe {
            ReaperFunctionPointers {
                ...
                __mergesort: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(__mergesort)).as_ptr()),
                ),
                AddCustomizableMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddCustomizableMenu)).as_ptr()),
                ),
                AddExtensionsMainMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddExtensionsMainMenu)).as_ptr()),
                ),
                AddMediaItemToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddMediaItemToTrack)).as_ptr()),
                ),
                AddProjectMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddProjectMarker)).as_ptr()),
                ),
                AddProjectMarker2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddProjectMarker2)).as_ptr()),
                ),
                AddRemoveReaScript: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddRemoveReaScript)).as_ptr()),
                ),
                AddTakeToMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddTakeToMediaItem)).as_ptr()),
                ),
                AddTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AddTempoTimeSigMarker)).as_ptr()),
                ),
                adjustZoom: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(adjustZoom)).as_ptr()),
                ),
                AnyTrackSolo: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(AnyTrackSolo)).as_ptr()),
                ),
                APIExists: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(APIExists)).as_ptr()),
                ),
                APITest: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(APITest)).as_ptr()),
                ),
                ApplyNudge: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ApplyNudge)).as_ptr()),
                ),
                ArmCommand: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ArmCommand)).as_ptr()),
                ),
                Audio_Init: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Audio_Init)).as_ptr()),
                ),
                Audio_IsPreBuffer: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Audio_IsPreBuffer)).as_ptr()),
                ),
                Audio_IsRunning: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Audio_IsRunning)).as_ptr()),
                ),
                ...
                Audio_RegHardwareHook: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Audio_RegHardwareHook)).as_ptr()),
                ),
                AudioAccessorStateChanged: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(AudioAccessorStateChanged)).as_ptr(),
                    ),
                ),
                AudioAccessorUpdate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(AudioAccessorUpdate)).as_ptr()),
                ),
                AudioAccessorValidateState: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(AudioAccessorValidateState)).as_ptr(),
                    ),
                ),
                ...
                CalculatePeaksFloatSrcPtr: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CalculatePeaksFloatSrcPtr)).as_ptr(),
                    ),
                ),
                ClearAllRecArmed: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ClearAllRecArmed)).as_ptr()),
                ),
                ClearConsole: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ClearConsole)).as_ptr()),
                ),
                ClearPeakCache: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ClearPeakCache)).as_ptr()),
                ),
                ColorFromNative: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ColorFromNative)).as_ptr()),
                ),
                ColorToNative: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ColorToNative)).as_ptr()),
                ),
                CountActionShortcuts: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountActionShortcuts)).as_ptr()),
                ),
                CountAutomationItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountAutomationItems)).as_ptr()),
                ),
                CountEnvelopePoints: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountEnvelopePoints)).as_ptr()),
                ),
                CountEnvelopePointsEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountEnvelopePointsEx)).as_ptr()),
                ),
                CountMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountMediaItems)).as_ptr()),
                ),
                CountProjectMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountProjectMarkers)).as_ptr()),
                ),
                CountSelectedMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountSelectedMediaItems)).as_ptr()),
                ),
                CountSelectedTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountSelectedTracks)).as_ptr()),
                ),
                CountSelectedTracks2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountSelectedTracks2)).as_ptr()),
                ),
                CountTakeEnvelopes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTakeEnvelopes)).as_ptr()),
                ),
                CountTakes: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CountTakes)).as_ptr()),
                ),
                CountTCPFXParms: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTCPFXParms)).as_ptr()),
                ),
                CountTempoTimeSigMarkers: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CountTempoTimeSigMarkers)).as_ptr(),
                    ),
                ),
                CountTrackEnvelopes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTrackEnvelopes)).as_ptr()),
                ),
                CountTrackMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CountTrackMediaItems)).as_ptr()),
                ),
                CountTracks: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CountTracks)).as_ptr()),
                ),
                CreateLocalOscHandler: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateLocalOscHandler)).as_ptr()),
                ),
                CreateMIDIInput: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateMIDIInput)).as_ptr()),
                ),
                CreateMIDIOutput: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateMIDIOutput)).as_ptr()),
                ),
                CreateNewMIDIItemInProj: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateNewMIDIItemInProj)).as_ptr()),
                ),
                CreateTakeAudioAccessor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateTakeAudioAccessor)).as_ptr()),
                ),
                CreateTrackAudioAccessor: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CreateTrackAudioAccessor)).as_ptr(),
                    ),
                ),
                CreateTrackSend: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CreateTrackSend)).as_ptr()),
                ),
                CSurf_FlushUndo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_FlushUndo)).as_ptr()),
                ),
                CSurf_GetTouchState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_GetTouchState)).as_ptr()),
                ),
                CSurf_GoEnd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_GoEnd)).as_ptr()),
                ),
                CSurf_GoStart: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_GoStart)).as_ptr()),
                ),
                CSurf_NumTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_NumTracks)).as_ptr()),
                ),
                CSurf_OnArrow: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnArrow)).as_ptr()),
                ),
                CSurf_OnFwd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnFwd)).as_ptr()),
                ),
                CSurf_OnFXChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnFXChange)).as_ptr()),
                ),
                CSurf_OnInputMonitorChange: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CSurf_OnInputMonitorChange)).as_ptr(),
                    ),
                ),
                CSurf_OnInputMonitorChangeEx: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(CSurf_OnInputMonitorChangeEx)).as_ptr(),
                )),
                CSurf_OnMuteChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnMuteChange)).as_ptr()),
                ),
                CSurf_OnMuteChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnMuteChangeEx)).as_ptr()),
                ),
                ...
                CSurf_OnPanChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPanChangeEx)).as_ptr()),
                ),
                CSurf_OnPause: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPause)).as_ptr()),
                ),
                CSurf_OnPlay: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPlay)).as_ptr()),
                ),
                CSurf_OnPlayRateChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnPlayRateChange)).as_ptr()),
                ),
                CSurf_OnRecArmChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRecArmChange)).as_ptr()),
                ),
                CSurf_OnRecArmChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRecArmChangeEx)).as_ptr()),
                ),
                CSurf_OnRecord: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRecord)).as_ptr()),
                ),
                CSurf_OnRecvPanChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRecvPanChange)).as_ptr()),
                ),
                CSurf_OnRecvVolumeChange: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CSurf_OnRecvVolumeChange)).as_ptr(),
                    ),
                ),
                CSurf_OnRew: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRew)).as_ptr()),
                ),
                CSurf_OnRewFwd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnRewFwd)).as_ptr()),
                ),
                CSurf_OnScroll: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnScroll)).as_ptr()),
                ),
                CSurf_OnSelectedChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnSelectedChange)).as_ptr()),
                ),
                CSurf_OnSendPanChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnSendPanChange)).as_ptr()),
                ),
                CSurf_OnSendVolumeChange: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CSurf_OnSendVolumeChange)).as_ptr(),
                    ),
                ),
                CSurf_OnSoloChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnSoloChange)).as_ptr()),
                ),
                CSurf_OnSoloChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnSoloChangeEx)).as_ptr()),
                ),
                ...
                CSurf_OnTempoChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnTempoChange)).as_ptr()),
                ),
                CSurf_OnTrackSelection: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnTrackSelection)).as_ptr()),
                ),
                CSurf_OnVolumeChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnVolumeChange)).as_ptr()),
                ),
                CSurf_OnVolumeChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnVolumeChangeEx)).as_ptr()),
                ),
                CSurf_OnWidthChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnWidthChange)).as_ptr()),
                ),
                CSurf_OnWidthChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnWidthChangeEx)).as_ptr()),
                ),
                CSurf_OnZoom: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(CSurf_OnZoom)).as_ptr()),
                ),
                CSurf_ResetAllCachedVolPanStates: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(CSurf_ResetAllCachedVolPanStates)).as_ptr(),
                )),
                CSurf_ScrubAmt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_ScrubAmt)).as_ptr()),
                ),
                CSurf_SetAutoMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetAutoMode)).as_ptr()),
                ),
                CSurf_SetPlayState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetPlayState)).as_ptr()),
                ),
                CSurf_SetRepeatState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetRepeatState)).as_ptr()),
                ),
                CSurf_SetSurfaceMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetSurfaceMute)).as_ptr()),
                ),
                CSurf_SetSurfacePan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetSurfacePan)).as_ptr()),
                ),
                CSurf_SetSurfaceRecArm: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetSurfaceRecArm)).as_ptr()),
                ),
                CSurf_SetSurfaceSelected: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CSurf_SetSurfaceSelected)).as_ptr(),
                    ),
                ),
                CSurf_SetSurfaceSolo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetSurfaceSolo)).as_ptr()),
                ),
                CSurf_SetSurfaceVolume: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_SetSurfaceVolume)).as_ptr()),
                ),
                CSurf_SetTrackListChange: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(CSurf_SetTrackListChange)).as_ptr(),
                    ),
                ),
                CSurf_TrackFromID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_TrackFromID)).as_ptr()),
                ),
                CSurf_TrackToID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CSurf_TrackToID)).as_ptr()),
                ),
                DB2SLIDER: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(DB2SLIDER)).as_ptr()),
                ),
                DeleteActionShortcut: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteActionShortcut)).as_ptr()),
                ),
                DeleteEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteEnvelopePointEx)).as_ptr()),
                ),
                DeleteEnvelopePointRange: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(DeleteEnvelopePointRange)).as_ptr(),
                    ),
                ),
                DeleteEnvelopePointRangeEx: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(DeleteEnvelopePointRangeEx)).as_ptr(),
                    ),
                ),
                DeleteExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteExtState)).as_ptr()),
                ),
                DeleteProjectMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteProjectMarker)).as_ptr()),
                ),
                ...
                DeleteTempoTimeSigMarker: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(DeleteTempoTimeSigMarker)).as_ptr(),
                    ),
                ),
                DeleteTrack: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(DeleteTrack)).as_ptr()),
                ),
                DeleteTrackMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DeleteTrackMediaItem)).as_ptr()),
                ),
                DestroyAudioAccessor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DestroyAudioAccessor)).as_ptr()),
                ),
                DestroyLocalOscHandler: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DestroyLocalOscHandler)).as_ptr()),
                ),
                DoActionShortcutDialog: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DoActionShortcutDialog)).as_ptr()),
                ),
                Dock_UpdateDockID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Dock_UpdateDockID)).as_ptr()),
                ),
                DockGetPosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockGetPosition)).as_ptr()),
                ),
                DockIsChildOfDock: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockIsChildOfDock)).as_ptr()),
                ),
                DockWindowActivate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockWindowActivate)).as_ptr()),
                ),
                DockWindowAdd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(DockWindowAdd)).as_ptr()),
                ),
                DockWindowAddEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockWindowAddEx)).as_ptr()),
                ),
                DockWindowRefresh: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockWindowRefresh)).as_ptr()),
                ),
                DockWindowRefreshForHWND: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(DockWindowRefreshForHWND)).as_ptr(),
                    ),
                ),
                DockWindowRemove: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(DockWindowRemove)).as_ptr()),
                ),
                DuplicateCustomizableMenu: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(DuplicateCustomizableMenu)).as_ptr(),
                    ),
                ),
                EditTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EditTempoTimeSigMarker)).as_ptr()),
                ),
                EnsureNotCompletelyOffscreen: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(EnsureNotCompletelyOffscreen)).as_ptr(),
                )),
                EnumerateFiles: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumerateFiles)).as_ptr()),
                ),
                ...
                EnumPitchShiftSubModes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumPitchShiftSubModes)).as_ptr()),
                ),
                EnumProjectMarkers: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumProjectMarkers)).as_ptr()),
                ),
                EnumProjectMarkers2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumProjectMarkers2)).as_ptr()),
                ),
                EnumProjectMarkers3: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumProjectMarkers3)).as_ptr()),
                ),
                EnumProjects: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(EnumProjects)).as_ptr()),
                ),
                EnumProjExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumProjExtState)).as_ptr()),
                ),
                EnumRegionRenderMatrix: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(EnumRegionRenderMatrix)).as_ptr()),
                ),
                EnumTrackMIDIProgramNames: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(EnumTrackMIDIProgramNames)).as_ptr(),
                    ),
                ),
                EnumTrackMIDIProgramNamesEx: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(EnumTrackMIDIProgramNamesEx)).as_ptr(),
                )),
                Envelope_Evaluate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_Evaluate)).as_ptr()),
                ),
                Envelope_FormatValue: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_FormatValue)).as_ptr()),
                ),
                Envelope_GetParentTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_GetParentTake)).as_ptr()),
                ),
                Envelope_GetParentTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_GetParentTrack)).as_ptr()),
                ),
                Envelope_SortPoints: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_SortPoints)).as_ptr()),
                ),
                Envelope_SortPointsEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Envelope_SortPointsEx)).as_ptr()),
                ),
                ExecProcess: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ExecProcess)).as_ptr()),
                ),
                file_exists: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(file_exists)).as_ptr()),
                ),
                FindTempoTimeSigMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(FindTempoTimeSigMarker)).as_ptr()),
                ),
                format_timestr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(format_timestr)).as_ptr()),
                ),
                format_timestr_len: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(format_timestr_len)).as_ptr()),
                ),
                format_timestr_pos: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(format_timestr_pos)).as_ptr()),
                ),
                FreeHeapPtr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(FreeHeapPtr)).as_ptr()),
                ),
                genGuid: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(genGuid)).as_ptr()),
                ),
                get_config_var: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(get_config_var)).as_ptr()),
                ),
                get_config_var_string: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(get_config_var_string)).as_ptr()),
                ),
                get_ini_file: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(get_ini_file)).as_ptr()),
                ),
                get_midi_config_var: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(get_midi_config_var)).as_ptr()),
                ),
                GetActionShortcutDesc: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetActionShortcutDesc)).as_ptr()),
                ),
                GetActiveTake: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetActiveTake)).as_ptr()),
                ),
                GetAllProjectPlayStates: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAllProjectPlayStates)).as_ptr()),
                ),
                GetAppVersion: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetAppVersion)).as_ptr()),
                ),
                GetArmedCommand: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetArmedCommand)).as_ptr()),
                ),
                GetAudioAccessorEndTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAudioAccessorEndTime)).as_ptr()),
                ),
                GetAudioAccessorHash: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAudioAccessorHash)).as_ptr()),
                ),
                GetAudioAccessorSamples: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAudioAccessorSamples)).as_ptr()),
                ),
                GetAudioAccessorStartTime: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetAudioAccessorStartTime)).as_ptr(),
                    ),
                ),
                GetAudioDeviceInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetAudioDeviceInfo)).as_ptr()),
                ),
                GetColorTheme: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetColorTheme)).as_ptr()),
                ),
                GetColorThemeStruct: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetColorThemeStruct)).as_ptr()),
                ),
                GetConfigWantsDock: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetConfigWantsDock)).as_ptr()),
                ),
                GetContextMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetContextMenu)).as_ptr()),
                ),
                GetCurrentProjectInLoadSave: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetCurrentProjectInLoadSave)).as_ptr(),
                )),
                GetCursorContext: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetCursorContext)).as_ptr()),
                ),
                GetCursorContext2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetCursorContext2)).as_ptr()),
                ),
                GetCursorPosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetCursorPosition)).as_ptr()),
                ),
                GetCursorPositionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetCursorPositionEx)).as_ptr()),
                ),
                GetDisplayedMediaItemColor: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetDisplayedMediaItemColor)).as_ptr(),
                    ),
                ),
                GetDisplayedMediaItemColor2: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetDisplayedMediaItemColor2)).as_ptr(),
                )),
                GetEnvelopeInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopeInfo_Value)).as_ptr()),
                ),
                GetEnvelopeName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopeName)).as_ptr()),
                ),
                GetEnvelopePoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopePoint)).as_ptr()),
                ),
                GetEnvelopePointByTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopePointByTime)).as_ptr()),
                ),
                GetEnvelopePointByTimeEx: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetEnvelopePointByTimeEx)).as_ptr(),
                    ),
                ),
                GetEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopePointEx)).as_ptr()),
                ),
                GetEnvelopeScalingMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetEnvelopeScalingMode)).as_ptr()),
                ),
                ...
                GetExtState: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetExtState)).as_ptr()),
                ),
                ...
                GetFXEnvelope: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetFXEnvelope)).as_ptr()),
                ),
                GetGlobalAutomationOverride: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetGlobalAutomationOverride)).as_ptr(),
                )),
                GetHZoomLevel: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetHZoomLevel)).as_ptr()),
                ),
                GetIconThemePointer: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetIconThemePointer)).as_ptr()),
                ),
                GetIconThemePointerForDPI: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetIconThemePointerForDPI)).as_ptr(),
                    ),
                ),
                ...
                GetInputChannelName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetInputChannelName)).as_ptr()),
                ),
                GetInputOutputLatency: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetInputOutputLatency)).as_ptr()),
                ),
                GetItemEditingTime2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetItemEditingTime2)).as_ptr()),
                ),
                GetItemFromPoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetItemFromPoint)).as_ptr()),
                ),
                GetItemProjectContext: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetItemProjectContext)).as_ptr()),
                ),
                GetItemStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetItemStateChunk)).as_ptr()),
                ),
                GetLastColorThemeFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetLastColorThemeFile)).as_ptr()),
                ),
                GetLastMarkerAndCurRegion: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetLastMarkerAndCurRegion)).as_ptr(),
                    ),
                ),
                GetLastTouchedFX: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetLastTouchedFX)).as_ptr()),
                ),
                GetLastTouchedTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetLastTouchedTrack)).as_ptr()),
                ),
                GetMainHwnd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetMainHwnd)).as_ptr()),
                ),
                GetMasterMuteSoloFlags: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMasterMuteSoloFlags)).as_ptr()),
                ),
                GetMasterTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMasterTrack)).as_ptr()),
                ),
                GetMasterTrackVisibility: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetMasterTrackVisibility)).as_ptr(),
                    ),
                ),
                GetMaxMidiInputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMaxMidiInputs)).as_ptr()),
                ),
                ...
                GetMediaItem_Track: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItem_Track)).as_ptr()),
                ),
                GetMediaItemInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemInfo_Value)).as_ptr()),
                ),
                GetMediaItemNumTakes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemNumTakes)).as_ptr()),
                ),
                GetMediaItemTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTake)).as_ptr()),
                ),
                GetMediaItemTake_Item: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTake_Item)).as_ptr()),
                ),
                GetMediaItemTake_Peaks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTake_Peaks)).as_ptr()),
                ),
                GetMediaItemTake_Source: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTake_Source)).as_ptr()),
                ),
                GetMediaItemTake_Track: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTake_Track)).as_ptr()),
                ),
                GetMediaItemTakeByGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTakeByGUID)).as_ptr()),
                ),
                GetMediaItemTakeInfo_Value: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetMediaItemTakeInfo_Value)).as_ptr(),
                    ),
                ),
                GetMediaItemTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaItemTrack)).as_ptr()),
                ),
                GetMediaSourceFileName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaSourceFileName)).as_ptr()),
                ),
                GetMediaSourceLength: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaSourceLength)).as_ptr()),
                ),
                GetMediaSourceNumChannels: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetMediaSourceNumChannels)).as_ptr(),
                    ),
                ),
                GetMediaSourceParent: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaSourceParent)).as_ptr()),
                ),
                GetMediaSourceSampleRate: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetMediaSourceSampleRate)).as_ptr(),
                    ),
                ),
                GetMediaSourceType: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaSourceType)).as_ptr()),
                ),
                GetMediaTrackInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMediaTrackInfo_Value)).as_ptr()),
                ),
                GetMIDIInputName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMIDIInputName)).as_ptr()),
                ),
                GetMIDIOutputName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMIDIOutputName)).as_ptr()),
                ),
                GetMixerScroll: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMixerScroll)).as_ptr()),
                ),
                GetMouseModifier: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMouseModifier)).as_ptr()),
                ),
                GetMousePosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetMousePosition)).as_ptr()),
                ),
                GetNumAudioInputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetNumAudioInputs)).as_ptr()),
                ),
                GetNumAudioOutputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetNumAudioOutputs)).as_ptr()),
                ),
                GetNumMIDIInputs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetNumMIDIInputs)).as_ptr()),
                ),
                ...
                GetOS: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetOS)).as_ptr()),
                ),
                GetOutputChannelName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetOutputChannelName)).as_ptr()),
                ),
                GetOutputLatency: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetOutputLatency)).as_ptr()),
                ),
                GetParentTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetParentTrack)).as_ptr()),
                ),
                GetPeakFileName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPeakFileName)).as_ptr()),
                ),
                GetPeakFileNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPeakFileNameEx)).as_ptr()),
                ),
                GetPeakFileNameEx2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPeakFileNameEx2)).as_ptr()),
                ),
                GetPeaksBitmap: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPeaksBitmap)).as_ptr()),
                ),
                GetPlayPosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayPosition)).as_ptr()),
                ),
                GetPlayPosition2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayPosition2)).as_ptr()),
                ),
                GetPlayPosition2Ex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayPosition2Ex)).as_ptr()),
                ),
                GetPlayPositionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayPositionEx)).as_ptr()),
                ),
                GetPlayState: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetPlayState)).as_ptr()),
                ),
                GetPlayStateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetPlayStateEx)).as_ptr()),
                ),
                GetPreferredDiskReadMode: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetPreferredDiskReadMode)).as_ptr(),
                    ),
                ),
                GetPreferredDiskReadModePeak: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetPreferredDiskReadModePeak)).as_ptr(),
                )),
                GetPreferredDiskWriteMode: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetPreferredDiskWriteMode)).as_ptr(),
                    ),
                ),
                GetProjectLength: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectLength)).as_ptr()),
                ),
                GetProjectName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectName)).as_ptr()),
                ),
                GetProjectPath: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectPath)).as_ptr()),
                ),
                GetProjectPathEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectPathEx)).as_ptr()),
                ),
                GetProjectStateChangeCount: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetProjectStateChangeCount)).as_ptr(),
                    ),
                ),
                GetProjectTimeOffset: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectTimeOffset)).as_ptr()),
                ),
                GetProjectTimeSignature: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjectTimeSignature)).as_ptr()),
                ),
                GetProjectTimeSignature2: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetProjectTimeSignature2)).as_ptr(),
                    ),
                ),
                GetProjExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetProjExtState)).as_ptr()),
                ),
                GetResourcePath: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetResourcePath)).as_ptr()),
                ),
                GetSelectedEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSelectedEnvelope)).as_ptr()),
                ),
                GetSelectedMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSelectedMediaItem)).as_ptr()),
                ),
                GetSelectedTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSelectedTrack)).as_ptr()),
                ),
                GetSelectedTrack2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSelectedTrack2)).as_ptr()),
                ),
                GetSelectedTrackEnvelope: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSelectedTrackEnvelope)).as_ptr(),
                    ),
                ),
                GetSet_ArrangeView2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSet_ArrangeView2)).as_ptr()),
                ),
                GetSet_LoopTimeRange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSet_LoopTimeRange)).as_ptr()),
                ),
                GetSet_LoopTimeRange2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSet_LoopTimeRange2)).as_ptr()),
                ),
                GetSetAutomationItemInfo: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetAutomationItemInfo)).as_ptr(),
                    ),
                ),
                GetSetAutomationItemInfo_String: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetSetAutomationItemInfo_String)).as_ptr(),
                )),
                GetSetEnvelopeInfo_String: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetEnvelopeInfo_String)).as_ptr(),
                    ),
                ),
                GetSetEnvelopeState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetEnvelopeState)).as_ptr()),
                ),
                GetSetEnvelopeState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetEnvelopeState2)).as_ptr()),
                ),
                GetSetItemState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetItemState)).as_ptr()),
                ),
                GetSetItemState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetItemState2)).as_ptr()),
                ),
                GetSetMediaItemInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetMediaItemInfo)).as_ptr()),
                ),
                GetSetMediaItemInfo_String: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetMediaItemInfo_String)).as_ptr(),
                    ),
                ),
                GetSetMediaItemTakeInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetMediaItemTakeInfo)).as_ptr()),
                ),
                GetSetMediaItemTakeInfo_String: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetSetMediaItemTakeInfo_String)).as_ptr(),
                )),
                GetSetMediaTrackInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetMediaTrackInfo)).as_ptr()),
                ),
                GetSetMediaTrackInfo_String: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetSetMediaTrackInfo_String)).as_ptr(),
                )),
                GetSetObjectState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetObjectState)).as_ptr()),
                ),
                GetSetObjectState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetObjectState2)).as_ptr()),
                ),
                GetSetProjectAuthor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetProjectAuthor)).as_ptr()),
                ),
                GetSetProjectGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetProjectGrid)).as_ptr()),
                ),
                GetSetProjectInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetProjectInfo)).as_ptr()),
                ),
                GetSetProjectInfo_String: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetProjectInfo_String)).as_ptr(),
                    ),
                ),
                GetSetProjectNotes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetProjectNotes)).as_ptr()),
                ),
                GetSetRepeat: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetSetRepeat)).as_ptr()),
                ),
                ...
                GetSetTrackMIDISupportFile: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetTrackMIDISupportFile)).as_ptr(),
                    ),
                ),
                GetSetTrackSendInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetTrackSendInfo)).as_ptr()),
                ),
                GetSetTrackSendInfo_String: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetSetTrackSendInfo_String)).as_ptr(),
                    ),
                ),
                GetSetTrackState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetTrackState)).as_ptr()),
                ),
                GetSetTrackState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSetTrackState2)).as_ptr()),
                ),
                GetSubProjectFromSource: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetSubProjectFromSource)).as_ptr()),
                ),
                GetTake: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTake)).as_ptr()),
                ),
                GetTakeEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTakeEnvelope)).as_ptr()),
                ),
                ...
                GetTakeNumStretchMarkers: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetTakeNumStretchMarkers)).as_ptr(),
                    ),
                ),
                GetTakeStretchMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTakeStretchMarker)).as_ptr()),
                ),
                GetTakeStretchMarkerSlope: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(GetTakeStretchMarkerSlope)).as_ptr(),
                    ),
                ),
                GetTCPFXParm: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTCPFXParm)).as_ptr()),
                ),
                GetTempoMatchPlayRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTempoMatchPlayRate)).as_ptr()),
                ),
                ...
                GetToggleCommandState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetToggleCommandState)).as_ptr()),
                ),
                GetToggleCommandState2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetToggleCommandState2)).as_ptr()),
                ),
                GetToggleCommandStateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetToggleCommandStateEx)).as_ptr()),
                ),
                GetToggleCommandStateThroughHooks: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetToggleCommandStateThroughHooks)).as_ptr(),
                )),
                ...
                GetTrackAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackAutomationMode)).as_ptr()),
                ),
                GetTrackColor: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackColor)).as_ptr()),
                ),
                GetTrackDepth: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackDepth)).as_ptr()),
                ),
                GetTrackEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackEnvelope)).as_ptr()),
                ),
                GetTrackEnvelopeByChunkName: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(GetTrackEnvelopeByChunkName)).as_ptr(),
                )),
                GetTrackEnvelopeByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackEnvelopeByName)).as_ptr()),
                ),
                GetTrackFromPoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackFromPoint)).as_ptr()),
                ),
                GetTrackGUID: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackGUID)).as_ptr()),
                ),
                GetTrackInfo: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackInfo)).as_ptr()),
                ),
                GetTrackMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackMediaItem)).as_ptr()),
                ),
                GetTrackMIDILyrics: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackMIDILyrics)).as_ptr()),
                ),
                GetTrackMIDINoteName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackMIDINoteName)).as_ptr()),
                ),
                GetTrackMIDINoteNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackMIDINoteNameEx)).as_ptr()),
                ),
                GetTrackMIDINoteRange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackMIDINoteRange)).as_ptr()),
                ),
                GetTrackName: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackName)).as_ptr()),
                ),
                GetTrackNumMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackNumMediaItems)).as_ptr()),
                ),
                GetTrackNumSends: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackNumSends)).as_ptr()),
                ),
                GetTrackReceiveName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackReceiveName)).as_ptr()),
                ),
                GetTrackReceiveUIMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackReceiveUIMute)).as_ptr()),
                ),
                GetTrackReceiveUIVolPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackReceiveUIVolPan)).as_ptr()),
                ),
                GetTrackSendInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackSendInfo_Value)).as_ptr()),
                ),
                GetTrackSendName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackSendName)).as_ptr()),
                ),
                GetTrackSendUIMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackSendUIMute)).as_ptr()),
                ),
                GetTrackSendUIVolPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackSendUIVolPan)).as_ptr()),
                ),
                GetTrackState: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackState)).as_ptr()),
                ),
                GetTrackStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackStateChunk)).as_ptr()),
                ),
                GetTrackUIMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackUIMute)).as_ptr()),
                ),
                GetTrackUIPan: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetTrackUIPan)).as_ptr()),
                ),
                GetTrackUIVolPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetTrackUIVolPan)).as_ptr()),
                ),
                GetUnderrunTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetUnderrunTime)).as_ptr()),
                ),
                GetUserFileNameForRead: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GetUserFileNameForRead)).as_ptr()),
                ),
                GetUserInputs: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetUserInputs)).as_ptr()),
                ),
                GoToMarker: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GoToMarker)).as_ptr()),
                ),
                GoToRegion: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GoToRegion)).as_ptr()),
                ),
                GR_SelectColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(GR_SelectColor)).as_ptr()),
                ),
                GSC_mainwnd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GSC_mainwnd)).as_ptr()),
                ),
                guidToString: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(guidToString)).as_ptr()),
                ),
                HasExtState: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(HasExtState)).as_ptr()),
                ),
                HasTrackMIDIPrograms: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(HasTrackMIDIPrograms)).as_ptr()),
                ),
                HasTrackMIDIProgramsEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(HasTrackMIDIProgramsEx)).as_ptr()),
                ),
                Help_Set: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Help_Set)).as_ptr()),
                ),
                HiresPeaksFromSource: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(HiresPeaksFromSource)).as_ptr()),
                ),
                image_resolve_fn: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(image_resolve_fn)).as_ptr()),
                ),
                InsertAutomationItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(InsertAutomationItem)).as_ptr()),
                ),
                InsertEnvelopePoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(InsertEnvelopePoint)).as_ptr()),
                ),
                InsertEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(InsertEnvelopePointEx)).as_ptr()),
                ),
                InsertMedia: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(InsertMedia)).as_ptr()),
                ),
                InsertMediaSection: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(InsertMediaSection)).as_ptr()),
                ),
                ...
                IsInRealTimeAudio: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsInRealTimeAudio)).as_ptr()),
                ),
                IsItemTakeActiveForPlayback: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(IsItemTakeActiveForPlayback)).as_ptr(),
                )),
                IsMediaExtension: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsMediaExtension)).as_ptr()),
                ),
                IsMediaItemSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsMediaItemSelected)).as_ptr()),
                ),
                IsProjectDirty: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsProjectDirty)).as_ptr()),
                ),
                IsREAPER: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(IsREAPER)).as_ptr()),
                ),
                IsTrackSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(IsTrackSelected)).as_ptr()),
                ),
                ...
                joystick_create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_create)).as_ptr()),
                ),
                joystick_destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_destroy)).as_ptr()),
                ),
                joystick_enum: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(joystick_enum)).as_ptr()),
                ),
                joystick_getaxis: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_getaxis)).as_ptr()),
                ),
                joystick_getbuttonmask: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_getbuttonmask)).as_ptr()),
                ),
                joystick_getinfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_getinfo)).as_ptr()),
                ),
                joystick_getpov: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_getpov)).as_ptr()),
                ),
                joystick_update: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(joystick_update)).as_ptr()),
                ),
                kbd_enumerateActions: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_enumerateActions)).as_ptr()),
                ),
                kbd_formatKeyName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_formatKeyName)).as_ptr()),
                ),
                kbd_getCommandName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_getCommandName)).as_ptr()),
                ),
                kbd_getTextFromCmd: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_getTextFromCmd)).as_ptr()),
                ),
                KBD_OnMainActionEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(KBD_OnMainActionEx)).as_ptr()),
                ),
                kbd_OnMidiEvent: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_OnMidiEvent)).as_ptr()),
                ),
                kbd_OnMidiList: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_OnMidiList)).as_ptr()),
                ),
                kbd_ProcessActionsMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_ProcessActionsMenu)).as_ptr()),
                ),
                kbd_processMidiEventActionEx: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(kbd_processMidiEventActionEx)).as_ptr(),
                )),
                kbd_reprocessMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(kbd_reprocessMenu)).as_ptr()),
                ),
                kbd_RunCommandThroughHooks: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(kbd_RunCommandThroughHooks)).as_ptr(),
                    ),
                ),
                ...
                LICE__DestroyFont: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__DestroyFont)).as_ptr()),
                ),
                LICE__DrawText: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__DrawText)).as_ptr()),
                ),
                LICE__GetBits: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE__GetBits)).as_ptr()),
                ),
                LICE__GetDC: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE__GetDC)).as_ptr()),
                ),
                LICE__GetHeight: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__GetHeight)).as_ptr()),
                ),
                LICE__GetRowSpan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__GetRowSpan)).as_ptr()),
                ),
                LICE__GetWidth: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__GetWidth)).as_ptr()),
                ),
                LICE__IsFlipped: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__IsFlipped)).as_ptr()),
                ),
                LICE__resize: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE__resize)).as_ptr()),
                ),
                LICE__SetBkColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__SetBkColor)).as_ptr()),
                ),
                LICE__SetFromHFont: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__SetFromHFont)).as_ptr()),
                ),
                LICE__SetTextColor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE__SetTextColor)).as_ptr()),
                ),
                LICE__SetTextCombineMode: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(LICE__SetTextCombineMode)).as_ptr(),
                    ),
                ),
                LICE_Arc: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Arc)).as_ptr()),
                ),
                LICE_Blit: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Blit)).as_ptr()),
                ),
                LICE_Blur: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Blur)).as_ptr()),
                ),
                LICE_BorderedRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_BorderedRect)).as_ptr()),
                ),
                LICE_Circle: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Circle)).as_ptr()),
                ),
                LICE_Clear: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Clear)).as_ptr()),
                ),
                LICE_ClearRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_ClearRect)).as_ptr()),
                ),
                ...
                LICE_CreateBitmap: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_CreateBitmap)).as_ptr()),
                ),
                LICE_CreateFont: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_CreateFont)).as_ptr()),
                ),
                LICE_DrawCBezier: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawCBezier)).as_ptr()),
                ),
                ...
                LICE_DrawGlyph: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawGlyph)).as_ptr()),
                ),
                LICE_DrawRect: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_DrawRect)).as_ptr()),
                ),
                ...
                LICE_FillCBezier: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillCBezier)).as_ptr()),
                ),
                LICE_FillCircle: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillCircle)).as_ptr()),
                ),
                LICE_FillConvexPolygon: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillConvexPolygon)).as_ptr()),
                ),
                LICE_FillRect: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_FillRect)).as_ptr()),
                ),
                LICE_FillTrapezoid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillTrapezoid)).as_ptr()),
                ),
                LICE_FillTriangle: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_FillTriangle)).as_ptr()),
                ),
                LICE_GetPixel: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_GetPixel)).as_ptr()),
                ),
                LICE_GradRect: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_GradRect)).as_ptr()),
                ),
                LICE_Line: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_Line)).as_ptr()),
                ),
                LICE_LineInt: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_LineInt)).as_ptr()),
                ),
                ...
                LICE_LoadPNGFromResource: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(LICE_LoadPNGFromResource)).as_ptr(),
                    ),
                ),
                LICE_MeasureText: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_MeasureText)).as_ptr()),
                ),
                LICE_MultiplyAddRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_MultiplyAddRect)).as_ptr()),
                ),
                LICE_PutPixel: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(LICE_PutPixel)).as_ptr()),
                ),
                LICE_RotatedBlit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_RotatedBlit)).as_ptr()),
                ),
                LICE_RoundRect: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_RoundRect)).as_ptr()),
                ),
                LICE_ScaledBlit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(LICE_ScaledBlit)).as_ptr()),
                ),
                ...
                Main_OnCommand: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Main_OnCommand)).as_ptr()),
                ),
                Main_OnCommandEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Main_OnCommandEx)).as_ptr()),
                ),
                Main_openProject: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Main_openProject)).as_ptr()),
                ),
                ...
                MarkProjectDirty: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MarkProjectDirty)).as_ptr()),
                ),
                MarkTrackItemsDirty: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MarkTrackItemsDirty)).as_ptr()),
                ),
                Master_GetPlayRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Master_GetPlayRate)).as_ptr()),
                ),
                Master_GetPlayRateAtTime: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(Master_GetPlayRateAtTime)).as_ptr(),
                    ),
                ),
                Master_GetTempo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Master_GetTempo)).as_ptr()),
                ),
                Master_NormalizePlayRate: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(Master_NormalizePlayRate)).as_ptr(),
                    ),
                ),
                Master_NormalizeTempo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Master_NormalizeTempo)).as_ptr()),
                ),
                ...
                MIDI_DeleteCC: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_DeleteCC)).as_ptr()),
                ),
                MIDI_DeleteEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_DeleteEvt)).as_ptr()),
                ),
                MIDI_DeleteNote: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_DeleteNote)).as_ptr()),
                ),
                MIDI_DeleteTextSysexEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_DeleteTextSysexEvt)).as_ptr()),
                ),
                MIDI_DisableSort: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_DisableSort)).as_ptr()),
                ),
                MIDI_EnumSelCC: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_EnumSelCC)).as_ptr()),
                ),
                MIDI_EnumSelEvts: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_EnumSelEvts)).as_ptr()),
                ),
                MIDI_EnumSelNotes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_EnumSelNotes)).as_ptr()),
                ),
                MIDI_EnumSelTextSysexEvts: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDI_EnumSelTextSysexEvts)).as_ptr(),
                    ),
                ),
                MIDI_eventlist_Create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_eventlist_Create)).as_ptr()),
                ),
                MIDI_eventlist_Destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_eventlist_Destroy)).as_ptr()),
                ),
                MIDI_GetAllEvts: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetAllEvts)).as_ptr()),
                ),
                MIDI_GetCC: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetCC)).as_ptr()),
                ),
                MIDI_GetCCShape: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetCCShape)).as_ptr()),
                ),
                MIDI_GetEvt: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetEvt)).as_ptr()),
                ),
                MIDI_GetGrid: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetGrid)).as_ptr()),
                ),
                ...
                MIDI_GetNote: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetNote)).as_ptr()),
                ),
                MIDI_GetPPQPos_EndOfMeasure: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(MIDI_GetPPQPos_EndOfMeasure)).as_ptr(),
                )),
                MIDI_GetPPQPos_StartOfMeasure: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(MIDI_GetPPQPos_StartOfMeasure)).as_ptr(),
                )),
                MIDI_GetPPQPosFromProjQN: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDI_GetPPQPosFromProjQN)).as_ptr(),
                    ),
                ),
                MIDI_GetPPQPosFromProjTime: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDI_GetPPQPosFromProjTime)).as_ptr(),
                    ),
                ),
                MIDI_GetProjQNFromPPQPos: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDI_GetProjQNFromPPQPos)).as_ptr(),
                    ),
                ),
                ...
                MIDI_GetTextSysexEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_GetTextSysexEvt)).as_ptr()),
                ),
                ...
                MIDI_InsertEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_InsertEvt)).as_ptr()),
                ),
                MIDI_InsertNote: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_InsertNote)).as_ptr()),
                ),
                ...
                MIDI_SelectAll: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SelectAll)).as_ptr()),
                ),
                MIDI_SetAllEvts: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetAllEvts)).as_ptr()),
                ),
                MIDI_SetCC: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetCC)).as_ptr()),
                ),
                MIDI_SetCCShape: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetCCShape)).as_ptr()),
                ),
                ...
                MIDI_SetItemExtents: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetItemExtents)).as_ptr()),
                ),
                MIDI_SetNote: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetNote)).as_ptr()),
                ),
                MIDI_SetTextSysexEvt: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDI_SetTextSysexEvt)).as_ptr()),
                ),
                ...
                MIDIEditor_GetMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDIEditor_GetMode)).as_ptr()),
                ),
                MIDIEditor_GetSetting_int: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDIEditor_GetSetting_int)).as_ptr(),
                    ),
                ),
                MIDIEditor_GetSetting_str: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(MIDIEditor_GetSetting_str)).as_ptr(),
                    ),
                ),
                MIDIEditor_GetTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDIEditor_GetTake)).as_ptr()),
                ),
                MIDIEditor_LastFocused_OnCommand: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(MIDIEditor_LastFocused_OnCommand)).as_ptr(),
                )),
                MIDIEditor_OnCommand: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MIDIEditor_OnCommand)).as_ptr()),
                ),
                ...
                mkvolpanstr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(mkvolpanstr)).as_ptr()),
                ),
                mkvolstr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(mkvolstr)).as_ptr()),
                ),
                MoveEditCursor: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MoveEditCursor)).as_ptr()),
                ),
                MoveMediaItemToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(MoveMediaItemToTrack)).as_ptr()),
                ),
                MuteAllTracks: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(MuteAllTracks)).as_ptr()),
                ),
                my_getViewport: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(my_getViewport)).as_ptr()),
                ),
                NamedCommandLookup: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(NamedCommandLookup)).as_ptr()),
                ),
                OnPauseButton: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(OnPauseButton)).as_ptr()),
                ),
                OnPauseButtonEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnPauseButtonEx)).as_ptr()),
                ),
                OnPlayButton: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(OnPlayButton)).as_ptr()),
                ),
                OnPlayButtonEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnPlayButtonEx)).as_ptr()),
                ),
                OnStopButton: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(OnStopButton)).as_ptr()),
                ),
                OnStopButtonEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OnStopButtonEx)).as_ptr()),
                ),
                OpenColorThemeFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OpenColorThemeFile)).as_ptr()),
                ),
                OpenMediaExplorer: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OpenMediaExplorer)).as_ptr()),
                ),
                OscLocalMessageToHost: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(OscLocalMessageToHost)).as_ptr()),
                ),
                parse_timestr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(parse_timestr)).as_ptr()),
                ),
                parse_timestr_len: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(parse_timestr_len)).as_ptr()),
                ),
                parse_timestr_pos: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(parse_timestr_pos)).as_ptr()),
                ),
                parsepanstr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(parsepanstr)).as_ptr()),
                ),
                PCM_Sink_Create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_Create)).as_ptr()),
                ),
                PCM_Sink_CreateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_CreateEx)).as_ptr()),
                ),
                PCM_Sink_CreateMIDIFile: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_CreateMIDIFile)).as_ptr()),
                ),
                PCM_Sink_CreateMIDIFileEx: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(PCM_Sink_CreateMIDIFileEx)).as_ptr(),
                    ),
                ),
                PCM_Sink_Enum: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_Enum)).as_ptr()),
                ),
                PCM_Sink_GetExtension: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Sink_GetExtension)).as_ptr()),
                ),
                ...
                PCM_Source_CreateFromFile: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(PCM_Source_CreateFromFile)).as_ptr(),
                    ),
                ),
                PCM_Source_CreateFromFileEx: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(PCM_Source_CreateFromFileEx)).as_ptr(),
                )),
                PCM_Source_CreateFromSimple: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(PCM_Source_CreateFromSimple)).as_ptr(),
                )),
                PCM_Source_CreateFromType: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(PCM_Source_CreateFromType)).as_ptr(),
                    ),
                ),
                PCM_Source_Destroy: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Source_Destroy)).as_ptr()),
                ),
                PCM_Source_GetPeaks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PCM_Source_GetPeaks)).as_ptr()),
                ),
                PCM_Source_GetSectionInfo: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(PCM_Source_GetSectionInfo)).as_ptr(),
                    ),
                ),
                PeakBuild_Create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PeakBuild_Create)).as_ptr()),
                ),
                PeakBuild_CreateEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PeakBuild_CreateEx)).as_ptr()),
                ),
                PeakGet_Create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PeakGet_Create)).as_ptr()),
                ),
                PitchShiftSubModeMenu: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PitchShiftSubModeMenu)).as_ptr()),
                ),
                PlayPreview: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(PlayPreview)).as_ptr()),
                ),
                PlayPreviewEx: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(PlayPreviewEx)).as_ptr()),
                ),
                PlayTrackPreview: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PlayTrackPreview)).as_ptr()),
                ),
                PlayTrackPreview2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PlayTrackPreview2)).as_ptr()),
                ),
                PlayTrackPreview2Ex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PlayTrackPreview2Ex)).as_ptr()),
                ),
                plugin_getapi: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(plugin_getapi)).as_ptr()),
                ),
                plugin_getFilterList: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(plugin_getFilterList)).as_ptr()),
                ),
                plugin_getImportableProjectFilterList: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(plugin_getImportableProjectFilterList)).as_ptr(),
                )),
                plugin_register: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(plugin_register)).as_ptr()),
                ),
                PluginWantsAlwaysRunFx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PluginWantsAlwaysRunFx)).as_ptr()),
                ),
                PreventUIRefresh: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(PreventUIRefresh)).as_ptr()),
                ),
                projectconfig_var_addr: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(projectconfig_var_addr)).as_ptr()),
                ),
                ...
                ReaperGetPitchShiftAPI: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ReaperGetPitchShiftAPI)).as_ptr()),
                ),
                ReaScriptError: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ReaScriptError)).as_ptr()),
                ),
                RecursiveCreateDirectory: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(RecursiveCreateDirectory)).as_ptr(),
                    ),
                ),
                reduce_open_files: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(reduce_open_files)).as_ptr()),
                ),
                RefreshToolbar: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(RefreshToolbar)).as_ptr()),
                ),
                RefreshToolbar2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(RefreshToolbar2)).as_ptr()),
                ),
                relative_fn: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(relative_fn)).as_ptr()),
                ),
                RemoveTrackSend: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(RemoveTrackSend)).as_ptr()),
                ),
                RenderFileSection: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(RenderFileSection)).as_ptr()),
                ),
                ReorderSelectedTracks: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ReorderSelectedTracks)).as_ptr()),
                ),
                Resample_EnumModes: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Resample_EnumModes)).as_ptr()),
                ),
                Resampler_Create: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Resampler_Create)).as_ptr()),
                ),
                resolve_fn: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(resolve_fn)).as_ptr()),
                ),
                ...
                ReverseNamedCommandLookup: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(ReverseNamedCommandLookup)).as_ptr(),
                    ),
                ),
                ScaleFromEnvelopeMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ScaleFromEnvelopeMode)).as_ptr()),
                ),
                ScaleToEnvelopeMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ScaleToEnvelopeMode)).as_ptr()),
                ),
                screenset_register: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(screenset_register)).as_ptr()),
                ),
                screenset_registerNew: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(screenset_registerNew)).as_ptr()),
                ),
                screenset_unregister: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(screenset_unregister)).as_ptr()),
                ),
                screenset_unregisterByParam: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(screenset_unregisterByParam)).as_ptr(),
                )),
                screenset_updateLastFocus: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(screenset_updateLastFocus)).as_ptr(),
                    ),
                ),
                SectionFromUniqueID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SectionFromUniqueID)).as_ptr()),
                ),
                SelectAllMediaItems: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SelectAllMediaItems)).as_ptr()),
                ),
                SelectProjectInstance: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SelectProjectInstance)).as_ptr()),
                ),
                ...
                SetAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetAutomationMode)).as_ptr()),
                ),
                SetCurrentBPM: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SetCurrentBPM)).as_ptr()),
                ),
                SetCursorContext: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetCursorContext)).as_ptr()),
                ),
                SetEditCurPos: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SetEditCurPos)).as_ptr()),
                ),
                SetEditCurPos2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetEditCurPos2)).as_ptr()),
                ),
                SetEnvelopePoint: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetEnvelopePoint)).as_ptr()),
                ),
                SetEnvelopePointEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetEnvelopePointEx)).as_ptr()),
                ),
                SetEnvelopeStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetEnvelopeStateChunk)).as_ptr()),
                ),
                SetExtState: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SetExtState)).as_ptr()),
                ),
                SetGlobalAutomationOverride: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(SetGlobalAutomationOverride)).as_ptr(),
                )),
                SetItemStateChunk: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetItemStateChunk)).as_ptr()),
                ),
                SetMasterTrackVisibility: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(SetMasterTrackVisibility)).as_ptr(),
                    ),
                ),
                SetMediaItemInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaItemInfo_Value)).as_ptr()),
                ),
                SetMediaItemLength: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaItemLength)).as_ptr()),
                ),
                SetMediaItemPosition: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaItemPosition)).as_ptr()),
                ),
                SetMediaItemSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaItemSelected)).as_ptr()),
                ),
                SetMediaItemTake_Source: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaItemTake_Source)).as_ptr()),
                ),
                SetMediaItemTakeInfo_Value: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(SetMediaItemTakeInfo_Value)).as_ptr(),
                    ),
                ),
                SetMediaTrackInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMediaTrackInfo_Value)).as_ptr()),
                ),
                SetMIDIEditorGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMIDIEditorGrid)).as_ptr()),
                ),
                SetMixerScroll: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMixerScroll)).as_ptr()),
                ),
                SetMouseModifier: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetMouseModifier)).as_ptr()),
                ),
                SetOnlyTrackSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetOnlyTrackSelected)).as_ptr()),
                ),
                SetProjectGrid: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectGrid)).as_ptr()),
                ),
                SetProjectMarker: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectMarker)).as_ptr()),
                ),
                SetProjectMarker2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectMarker2)).as_ptr()),
                ),
                SetProjectMarker3: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectMarker3)).as_ptr()),
                ),
                SetProjectMarker4: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectMarker4)).as_ptr()),
                ),
                SetProjectMarkerByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjectMarkerByIndex)).as_ptr()),
                ),
                SetProjectMarkerByIndex2: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(SetProjectMarkerByIndex2)).as_ptr(),
                    ),
                ),
                SetProjExtState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetProjExtState)).as_ptr()),
                ),
                SetRegionRenderMatrix: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetRegionRenderMatrix)).as_ptr()),
                ),
                ...
                SetTakeStretchMarkerSlope: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(SetTakeStretchMarkerSlope)).as_ptr(),
                    ),
                ),
                ...
                SetToggleCommandState: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetToggleCommandState)).as_ptr()),
                ),
                SetTrackAutomationMode: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackAutomationMode)).as_ptr()),
                ),
                SetTrackColor: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SetTrackColor)).as_ptr()),
                ),
                SetTrackMIDILyrics: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackMIDILyrics)).as_ptr()),
                ),
                SetTrackMIDINoteName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackMIDINoteName)).as_ptr()),
                ),
                SetTrackMIDINoteNameEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackMIDINoteNameEx)).as_ptr()),
                ),
                SetTrackSelected: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackSelected)).as_ptr()),
                ),
                SetTrackSendInfo_Value: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackSendInfo_Value)).as_ptr()),
                ),
                SetTrackSendUIPan: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackSendUIPan)).as_ptr()),
                ),
                SetTrackSendUIVol: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SetTrackSendUIVol)).as_ptr()),
                ),
                ...
                ShowActionList: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ShowActionList)).as_ptr()),
                ),
                ShowConsoleMsg: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ShowConsoleMsg)).as_ptr()),
                ),
                ShowMessageBox: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ShowMessageBox)).as_ptr()),
                ),
                ShowPopupMenu: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ShowPopupMenu)).as_ptr()),
                ),
                SLIDER2DB: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SLIDER2DB)).as_ptr()),
                ),
                SnapToGrid: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SnapToGrid)).as_ptr()),
                ),
                SoloAllTracks: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(SoloAllTracks)).as_ptr()),
                ),
                Splash_GetWnd: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Splash_GetWnd)).as_ptr()),
                ),
                SplitMediaItem: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(SplitMediaItem)).as_ptr()),
                ),
                StopPreview: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(StopPreview)).as_ptr()),
                ),
                StopTrackPreview: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(StopTrackPreview)).as_ptr()),
                ),
                StopTrackPreview2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(StopTrackPreview2)).as_ptr()),
                ),
                stringToGuid: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(stringToGuid)).as_ptr()),
                ),
                StuffMIDIMessage: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(StuffMIDIMessage)).as_ptr()),
                ),
                TakeFX_AddByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_AddByName)).as_ptr()),
                ),
                TakeFX_CopyToTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_CopyToTake)).as_ptr()),
                ),
                TakeFX_CopyToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_CopyToTrack)).as_ptr()),
                ),
                TakeFX_Delete: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(TakeFX_Delete)).as_ptr()),
                ),
                TakeFX_EndParamEdit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_EndParamEdit)).as_ptr()),
                ),
                TakeFX_FormatParamValue: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_FormatParamValue)).as_ptr()),
                ),
                TakeFX_FormatParamValueNormalized: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TakeFX_FormatParamValueNormalized)).as_ptr(),
                )),
                TakeFX_GetChainVisible: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetChainVisible)).as_ptr()),
                ),
                TakeFX_GetCount: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetCount)).as_ptr()),
                ),
                TakeFX_GetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetEnabled)).as_ptr()),
                ),
                TakeFX_GetEnvelope: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetEnvelope)).as_ptr()),
                ),
                TakeFX_GetFloatingWindow: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TakeFX_GetFloatingWindow)).as_ptr(),
                    ),
                ),
                TakeFX_GetFormattedParamValue: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TakeFX_GetFormattedParamValue)).as_ptr(),
                )),
                TakeFX_GetFXGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetFXGUID)).as_ptr()),
                ),
                TakeFX_GetFXName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetFXName)).as_ptr()),
                ),
                TakeFX_GetIOSize: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetIOSize)).as_ptr()),
                ),
                TakeFX_GetNamedConfigParm: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TakeFX_GetNamedConfigParm)).as_ptr(),
                    ),
                ),
                TakeFX_GetNumParams: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetNumParams)).as_ptr()),
                ),
                TakeFX_GetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetOffline)).as_ptr()),
                ),
                TakeFX_GetOpen: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetOpen)).as_ptr()),
                ),
                TakeFX_GetParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetParam)).as_ptr()),
                ),
                TakeFX_GetParameterStepSizes: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TakeFX_GetParameterStepSizes)).as_ptr(),
                )),
                ...
                TakeFX_GetParamNormalized: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TakeFX_GetParamNormalized)).as_ptr(),
                    ),
                ),
                TakeFX_GetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetPinMappings)).as_ptr()),
                ),
                TakeFX_GetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetPreset)).as_ptr()),
                ),
                TakeFX_GetPresetIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_GetPresetIndex)).as_ptr()),
                ),
                TakeFX_GetUserPresetFilename: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TakeFX_GetUserPresetFilename)).as_ptr(),
                )),
                TakeFX_NavigatePresets: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_NavigatePresets)).as_ptr()),
                ),
                TakeFX_SetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetEnabled)).as_ptr()),
                ),
                TakeFX_SetNamedConfigParm: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TakeFX_SetNamedConfigParm)).as_ptr(),
                    ),
                ),
                TakeFX_SetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetOffline)).as_ptr()),
                ),
                TakeFX_SetOpen: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetOpen)).as_ptr()),
                ),
                TakeFX_SetParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetParam)).as_ptr()),
                ),
                TakeFX_SetParamNormalized: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TakeFX_SetParamNormalized)).as_ptr(),
                    ),
                ),
                TakeFX_SetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetPinMappings)).as_ptr()),
                ),
                TakeFX_SetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetPreset)).as_ptr()),
                ),
                TakeFX_SetPresetByIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TakeFX_SetPresetByIndex)).as_ptr()),
                ),
                TakeFX_Show: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(TakeFX_Show)).as_ptr()),
                ),
                TakeIsMIDI: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(TakeIsMIDI)).as_ptr()),
                ),
                ThemeLayout_GetLayout: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ThemeLayout_GetLayout)).as_ptr()),
                ),
                ThemeLayout_GetParameter: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(ThemeLayout_GetParameter)).as_ptr(),
                    ),
                ),
                ThemeLayout_RefreshAll: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ThemeLayout_RefreshAll)).as_ptr()),
                ),
                ThemeLayout_SetLayout: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ThemeLayout_SetLayout)).as_ptr()),
                ),
                ThemeLayout_SetParameter: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(ThemeLayout_SetParameter)).as_ptr(),
                    ),
                ),
                time_precise: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(time_precise)).as_ptr()),
                ),
                TimeMap2_beatsToTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap2_beatsToTime)).as_ptr()),
                ),
                TimeMap2_GetDividedBpmAtTime: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TimeMap2_GetDividedBpmAtTime)).as_ptr(),
                )),
                TimeMap2_GetNextChangeTime: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TimeMap2_GetNextChangeTime)).as_ptr(),
                    ),
                ),
                TimeMap2_QNToTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap2_QNToTime)).as_ptr()),
                ),
                TimeMap2_timeToBeats: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap2_timeToBeats)).as_ptr()),
                ),
                TimeMap2_timeToQN: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap2_timeToQN)).as_ptr()),
                ),
                TimeMap_curFrameRate: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_curFrameRate)).as_ptr()),
                ),
                TimeMap_GetDividedBpmAtTime: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TimeMap_GetDividedBpmAtTime)).as_ptr(),
                )),
                TimeMap_GetMeasureInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_GetMeasureInfo)).as_ptr()),
                ),
                TimeMap_GetMetronomePattern: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TimeMap_GetMetronomePattern)).as_ptr(),
                )),
                TimeMap_GetTimeSigAtTime: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TimeMap_GetTimeSigAtTime)).as_ptr(),
                    ),
                ),
                TimeMap_QNToMeasures: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_QNToMeasures)).as_ptr()),
                ),
                TimeMap_QNToTime: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_QNToTime)).as_ptr()),
                ),
                TimeMap_QNToTime_abs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_QNToTime_abs)).as_ptr()),
                ),
                TimeMap_timeToQN: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_timeToQN)).as_ptr()),
                ),
                TimeMap_timeToQN_abs: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TimeMap_timeToQN_abs)).as_ptr()),
                ),
                ToggleTrackSendUIMute: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(ToggleTrackSendUIMute)).as_ptr()),
                ),
                Track_GetPeakHoldDB: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Track_GetPeakHoldDB)).as_ptr()),
                ),
                Track_GetPeakInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Track_GetPeakInfo)).as_ptr()),
                ),
                TrackCtl_SetToolTip: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackCtl_SetToolTip)).as_ptr()),
                ),
                TrackFX_AddByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_AddByName)).as_ptr()),
                ),
                TrackFX_CopyToTake: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_CopyToTake)).as_ptr()),
                ),
                TrackFX_CopyToTrack: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_CopyToTrack)).as_ptr()),
                ),
                TrackFX_Delete: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_Delete)).as_ptr()),
                ),
                TrackFX_EndParamEdit: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_EndParamEdit)).as_ptr()),
                ),
                TrackFX_FormatParamValue: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_FormatParamValue)).as_ptr(),
                    ),
                ),
                TrackFX_FormatParamValueNormalized: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TrackFX_FormatParamValueNormalized)).as_ptr(),
                )),
                TrackFX_GetByName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetByName)).as_ptr()),
                ),
                TrackFX_GetChainVisible: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetChainVisible)).as_ptr()),
                ),
                TrackFX_GetCount: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetCount)).as_ptr()),
                ),
                TrackFX_GetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetEnabled)).as_ptr()),
                ),
                TrackFX_GetEQ: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetEQ)).as_ptr()),
                ),
                TrackFX_GetEQBandEnabled: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_GetEQBandEnabled)).as_ptr(),
                    ),
                ),
                TrackFX_GetEQParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetEQParam)).as_ptr()),
                ),
                TrackFX_GetFloatingWindow: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_GetFloatingWindow)).as_ptr(),
                    ),
                ),
                TrackFX_GetFormattedParamValue: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TrackFX_GetFormattedParamValue)).as_ptr(),
                )),
                TrackFX_GetFXGUID: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetFXGUID)).as_ptr()),
                ),
                TrackFX_GetFXName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetFXName)).as_ptr()),
                ),
                TrackFX_GetInstrument: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetInstrument)).as_ptr()),
                ),
                TrackFX_GetIOSize: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetIOSize)).as_ptr()),
                ),
                TrackFX_GetNamedConfigParm: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_GetNamedConfigParm)).as_ptr(),
                    ),
                ),
                TrackFX_GetNumParams: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetNumParams)).as_ptr()),
                ),
                TrackFX_GetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetOffline)).as_ptr()),
                ),
                TrackFX_GetOpen: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetOpen)).as_ptr()),
                ),
                TrackFX_GetParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetParam)).as_ptr()),
                ),
                TrackFX_GetParameterStepSizes: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TrackFX_GetParameterStepSizes)).as_ptr(),
                )),
                ...
                TrackFX_GetParamName: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetParamName)).as_ptr()),
                ),
                TrackFX_GetParamNormalized: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_GetParamNormalized)).as_ptr(),
                    ),
                ),
                TrackFX_GetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetPinMappings)).as_ptr()),
                ),
                TrackFX_GetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetPreset)).as_ptr()),
                ),
                TrackFX_GetPresetIndex: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetPresetIndex)).as_ptr()),
                ),
                TrackFX_GetRecChainVisible: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_GetRecChainVisible)).as_ptr(),
                    ),
                ),
                TrackFX_GetRecCount: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_GetRecCount)).as_ptr()),
                ),
                TrackFX_GetUserPresetFilename: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TrackFX_GetUserPresetFilename)).as_ptr(),
                )),
                TrackFX_NavigatePresets: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_NavigatePresets)).as_ptr()),
                ),
                TrackFX_SetEnabled: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetEnabled)).as_ptr()),
                ),
                TrackFX_SetEQBandEnabled: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_SetEQBandEnabled)).as_ptr(),
                    ),
                ),
                TrackFX_SetEQParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetEQParam)).as_ptr()),
                ),
                TrackFX_SetNamedConfigParm: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_SetNamedConfigParm)).as_ptr(),
                    ),
                ),
                TrackFX_SetOffline: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetOffline)).as_ptr()),
                ),
                TrackFX_SetOpen: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetOpen)).as_ptr()),
                ),
                TrackFX_SetParam: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetParam)).as_ptr()),
                ),
                TrackFX_SetParamNormalized: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_SetParamNormalized)).as_ptr(),
                    ),
                ),
                TrackFX_SetPinMappings: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetPinMappings)).as_ptr()),
                ),
                TrackFX_SetPreset: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackFX_SetPreset)).as_ptr()),
                ),
                TrackFX_SetPresetByIndex: std::mem::transmute(
                    plugin_context.GetFunc(
                        c_str_macro::c_str!(stringify!(TrackFX_SetPresetByIndex)).as_ptr(),
                    ),
                ),
                TrackFX_Show: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(TrackFX_Show)).as_ptr()),
                ),
                TrackList_AdjustWindows: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(TrackList_AdjustWindows)).as_ptr()),
                ),
                TrackList_UpdateAllExternalSurfaces: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(TrackList_UpdateAllExternalSurfaces)).as_ptr(),
                )),
                Undo_BeginBlock: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_BeginBlock)).as_ptr()),
                ),
                Undo_BeginBlock2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_BeginBlock2)).as_ptr()),
                ),
                Undo_CanRedo2: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Undo_CanRedo2)).as_ptr()),
                ),
                Undo_CanUndo2: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Undo_CanUndo2)).as_ptr()),
                ),
                Undo_DoRedo2: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Undo_DoRedo2)).as_ptr()),
                ),
                Undo_DoUndo2: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Undo_DoUndo2)).as_ptr()),
                ),
                Undo_EndBlock: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(Undo_EndBlock)).as_ptr()),
                ),
                Undo_EndBlock2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_EndBlock2)).as_ptr()),
                ),
                Undo_OnStateChange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_OnStateChange)).as_ptr()),
                ),
                Undo_OnStateChange2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_OnStateChange2)).as_ptr()),
                ),
                Undo_OnStateChange_Item: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_OnStateChange_Item)).as_ptr()),
                ),
                Undo_OnStateChangeEx: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_OnStateChangeEx)).as_ptr()),
                ),
                Undo_OnStateChangeEx2: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(Undo_OnStateChangeEx2)).as_ptr()),
                ),
                update_disk_counters: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(update_disk_counters)).as_ptr()),
                ),
                UpdateArrange: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(UpdateArrange)).as_ptr()),
                ),
                ...
                ValidatePtr: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ValidatePtr)).as_ptr()),
                ),
                ValidatePtr2: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ValidatePtr2)).as_ptr()),
                ),
                ViewPrefs: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(ViewPrefs)).as_ptr()),
                ),
                WDL_VirtualWnd_ScaledBlitBG: std::mem::transmute(plugin_context.GetFunc(
                    c_str_macro::c_str!(stringify!(WDL_VirtualWnd_ScaledBlitBG)).as_ptr(),
                )),
                GetMidiInput: std::mem::transmute(
                    plugin_context.GetFunc(c_str_macro::c_str!(stringify!(GetMidiInput)).as_ptr()),
                ),
                ...
                UninitializeCoolSB: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(UninitializeCoolSB)).as_ptr()),
                ),
                CoolSB_SetMinThumbSize: std::mem::transmute(
                    plugin_context
                ...
                CoolSB_SetScrollInfo: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CoolSB_SetScrollInfo)).as_ptr()),
                ),
                CoolSB_SetScrollPos: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CoolSB_SetScrollPos)).as_ptr()),
                ),
                CoolSB_SetScrollRange: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CoolSB_SetScrollRange)).as_ptr()),
                ),
                CoolSB_ShowScrollBar: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CoolSB_ShowScrollBar)).as_ptr()),
                ),
                CoolSB_SetResizingThumb: std::mem::transmute(
                    plugin_context
                        .GetFunc(c_str_macro::c_str!(stringify!(CoolSB_SetResizingThumb)).as_ptr()),
                ),
        ...
        if pointers.__mergesort.is_some() {
            loaded_count += 1;
        }
        if pointers.AddCustomizableMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.AddExtensionsMainMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.AddMediaItemToTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.AddProjectMarker.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.AddTakeToMediaItem.is_some() {
            loaded_count += 1;
        }
        if pointers.AddTempoTimeSigMarker.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.APIExists.is_some() {
            loaded_count += 1;
        }
        if pointers.APITest.is_some() {
            loaded_count += 1;
        }
        if pointers.ApplyNudge.is_some() {
            loaded_count += 1;
        }
        if pointers.ArmCommand.is_some() {
            loaded_count += 1;
        }
        if pointers.Audio_Init.is_some() {
            loaded_count += 1;
        }
        if pointers.Audio_IsPreBuffer.is_some() {
            loaded_count += 1;
        }
        if pointers.Audio_IsRunning.is_some() {
            loaded_count += 1;
        }
        if pointers.Audio_Quit.is_some() {
            loaded_count += 1;
        }
        if pointers.Audio_RegHardwareHook.is_some() {
            loaded_count += 1;
        }
        if pointers.AudioAccessorStateChanged.is_some() {
            loaded_count += 1;
        }
        if pointers.AudioAccessorUpdate.is_some() {
            loaded_count += 1;
        }
        if pointers.AudioAccessorValidateState.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.CalculatePeaksFloatSrcPtr.is_some() {
            loaded_count += 1;
        }
        if pointers.ClearAllRecArmed.is_some() {
            loaded_count += 1;
        }
        if pointers.ClearConsole.is_some() {
            loaded_count += 1;
        }
        if pointers.ClearPeakCache.is_some() {
            loaded_count += 1;
        }
        if pointers.ColorFromNative.is_some() {
            loaded_count += 1;
        }
        if pointers.ColorToNative.is_some() {
            loaded_count += 1;
        }
        if pointers.CountActionShortcuts.is_some() {
            loaded_count += 1;
        }
        if pointers.CountAutomationItems.is_some() {
            loaded_count += 1;
        }
        if pointers.CountEnvelopePoints.is_some() {
            loaded_count += 1;
        }
        if pointers.CountEnvelopePointsEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CountMediaItems.is_some() {
            loaded_count += 1;
        }
        if pointers.CountProjectMarkers.is_some() {
            loaded_count += 1;
        }
        if pointers.CountSelectedMediaItems.is_some() {
            loaded_count += 1;
        }
        if pointers.CountSelectedTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.CountSelectedTracks2.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTakeEnvelopes.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTakes.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTCPFXParms.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTempoTimeSigMarkers.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTrackEnvelopes.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTrackMediaItems.is_some() {
            loaded_count += 1;
        }
        if pointers.CountTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateLocalOscHandler.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateMIDIInput.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateMIDIOutput.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateNewMIDIItemInProj.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateTakeAudioAccessor.is_some() {
            loaded_count += 1;
        }
        if pointers.CreateTrackAudioAccessor.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.CSurf_GetTouchState.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_GoEnd.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_GoStart.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_NumTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnArrow.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnFwd.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnFXChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnInputMonitorChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnInputMonitorChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnMuteChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnMuteChangeEx.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.CSurf_OnPanChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnPause.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnPlay.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnPlayRateChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRecArmChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRecArmChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRecord.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRecvPanChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRecvVolumeChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRew.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnRewFwd.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnScroll.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnSelectedChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnSendPanChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnSendVolumeChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnSoloChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnSoloChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnStop.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnTempoChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnTrackSelection.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnVolumeChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnVolumeChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnWidthChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnWidthChangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_OnZoom.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_ResetAllCachedVolPanStates.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_ScrubAmt.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetAutoMode.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetPlayState.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetRepeatState.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfaceMute.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfacePan.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfaceRecArm.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfaceSelected.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfaceSolo.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetSurfaceVolume.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_SetTrackListChange.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_TrackFromID.is_some() {
            loaded_count += 1;
        }
        if pointers.CSurf_TrackToID.is_some() {
            loaded_count += 1;
        }
        if pointers.DB2SLIDER.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteActionShortcut.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteEnvelopePointEx.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteEnvelopePointRange.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteEnvelopePointRangeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteExtState.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteProjectMarker.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.DeleteTempoTimeSigMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.DeleteTrackMediaItem.is_some() {
            loaded_count += 1;
        }
        if pointers.DestroyAudioAccessor.is_some() {
            loaded_count += 1;
        }
        if pointers.DestroyLocalOscHandler.is_some() {
            loaded_count += 1;
        }
        if pointers.DoActionShortcutDialog.is_some() {
            loaded_count += 1;
        }
        if pointers.Dock_UpdateDockID.is_some() {
            loaded_count += 1;
        }
        if pointers.DockGetPosition.is_some() {
            loaded_count += 1;
        }
        if pointers.DockIsChildOfDock.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowActivate.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowAdd.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowAddEx.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowRefresh.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowRefreshForHWND.is_some() {
            loaded_count += 1;
        }
        if pointers.DockWindowRemove.is_some() {
            loaded_count += 1;
        }
        if pointers.DuplicateCustomizableMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.EditTempoTimeSigMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.EnsureNotCompletelyOffscreen.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumerateFiles.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.EnumPitchShiftSubModes.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumProjectMarkers.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumProjectMarkers2.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumProjectMarkers3.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumProjects.is_some() {
            loaded_count += 1;
        }
        if pointers.EnumProjExtState.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.EnumTrackMIDIProgramNamesEx.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_Evaluate.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_FormatValue.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_GetParentTake.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_GetParentTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_SortPoints.is_some() {
            loaded_count += 1;
        }
        if pointers.Envelope_SortPointsEx.is_some() {
            loaded_count += 1;
        }
        if pointers.ExecProcess.is_some() {
            loaded_count += 1;
        }
        if pointers.file_exists.is_some() {
            loaded_count += 1;
        }
        if pointers.FindTempoTimeSigMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.format_timestr.is_some() {
            loaded_count += 1;
        }
        if pointers.format_timestr_len.is_some() {
            loaded_count += 1;
        }
        if pointers.format_timestr_pos.is_some() {
            loaded_count += 1;
        }
        if pointers.FreeHeapPtr.is_some() {
            loaded_count += 1;
        }
        if pointers.genGuid.is_some() {
            loaded_count += 1;
        }
        if pointers.get_config_var.is_some() {
            loaded_count += 1;
        }
        if pointers.get_config_var_string.is_some() {
            loaded_count += 1;
        }
        if pointers.get_ini_file.is_some() {
            loaded_count += 1;
        }
        if pointers.get_midi_config_var.is_some() {
            loaded_count += 1;
        }
        if pointers.GetActionShortcutDesc.is_some() {
            loaded_count += 1;
        }
        if pointers.GetActiveTake.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAllProjectPlayStates.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAppVersion.is_some() {
            loaded_count += 1;
        }
        if pointers.GetArmedCommand.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAudioAccessorEndTime.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAudioAccessorHash.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAudioAccessorSamples.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAudioAccessorStartTime.is_some() {
            loaded_count += 1;
        }
        if pointers.GetAudioDeviceInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetColorTheme.is_some() {
            loaded_count += 1;
        }
        if pointers.GetColorThemeStruct.is_some() {
            loaded_count += 1;
        }
        if pointers.GetConfigWantsDock.is_some() {
            loaded_count += 1;
        }
        if pointers.GetContextMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.GetCurrentProjectInLoadSave.is_some() {
            loaded_count += 1;
        }
        if pointers.GetCursorContext.is_some() {
            loaded_count += 1;
        }
        if pointers.GetCursorContext2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetCursorPosition.is_some() {
            loaded_count += 1;
        }
        if pointers.GetCursorPositionEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetDisplayedMediaItemColor.is_some() {
            loaded_count += 1;
        }
        if pointers.GetDisplayedMediaItemColor2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopeInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopeName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopePoint.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopePointByTime.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopePointByTimeEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopePointEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetEnvelopeScalingMode.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetExtState.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetFXEnvelope.is_some() {
            loaded_count += 1;
        }
        if pointers.GetGlobalAutomationOverride.is_some() {
            loaded_count += 1;
        }
        if pointers.GetHZoomLevel.is_some() {
            loaded_count += 1;
        }
        if pointers.GetIconThemePointer.is_some() {
            loaded_count += 1;
        }
        if pointers.GetIconThemePointerForDPI.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetInputOutputLatency.is_some() {
            loaded_count += 1;
        }
        if pointers.GetItemEditingTime2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetItemFromPoint.is_some() {
            loaded_count += 1;
        }
        if pointers.GetItemProjectContext.is_some() {
            loaded_count += 1;
        }
        if pointers.GetItemStateChunk.is_some() {
            loaded_count += 1;
        }
        if pointers.GetLastColorThemeFile.is_some() {
            loaded_count += 1;
        }
        if pointers.GetLastMarkerAndCurRegion.is_some() {
            loaded_count += 1;
        }
        if pointers.GetLastTouchedFX.is_some() {
            loaded_count += 1;
        }
        if pointers.GetLastTouchedTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMainHwnd.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMasterMuteSoloFlags.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMasterTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMasterTrackVisibility.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMaxMidiInputs.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetMediaItem_Track.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemNumTakes.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTake.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTake_Item.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTake_Peaks.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTake_Source.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTake_Track.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTakeByGUID.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTakeInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaItemTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceFileName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceLength.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceNumChannels.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceParent.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceSampleRate.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaSourceType.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMediaTrackInfo_Value.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetMouseModifier.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMousePosition.is_some() {
            loaded_count += 1;
        }
        if pointers.GetNumAudioInputs.is_some() {
            loaded_count += 1;
        }
        if pointers.GetNumAudioOutputs.is_some() {
            loaded_count += 1;
        }
        if pointers.GetNumMIDIInputs.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetOS.is_some() {
            loaded_count += 1;
        }
        if pointers.GetOutputChannelName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetOutputLatency.is_some() {
            loaded_count += 1;
        }
        if pointers.GetParentTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPeakFileName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPeakFileNameEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPeakFileNameEx2.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetPlayPosition2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPlayPosition2Ex.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPlayPositionEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPlayState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPlayStateEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPreferredDiskReadMode.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPreferredDiskReadModePeak.is_some() {
            loaded_count += 1;
        }
        if pointers.GetPreferredDiskWriteMode.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectLength.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectPath.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectPathEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectStateChangeCount.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectTimeOffset.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectTimeSignature.is_some() {
            loaded_count += 1;
        }
        if pointers.GetProjectTimeSignature2.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetSelectedEnvelope.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSelectedMediaItem.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSelectedTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSelectedTrack2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSelectedTrackEnvelope.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSet_ArrangeView2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSet_LoopTimeRange.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSet_LoopTimeRange2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetAutomationItemInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetAutomationItemInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetEnvelopeInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetEnvelopeState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetEnvelopeState2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetItemState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetItemState2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaItemInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaItemInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaItemTakeInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaItemTakeInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaTrackInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetMediaTrackInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetObjectState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetObjectState2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetProjectAuthor.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetProjectGrid.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetProjectInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetProjectInfo_String.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetSetTrackMIDISupportFile.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetTrackSendInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetTrackSendInfo_String.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetTrackState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSetTrackState2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetSubProjectFromSource.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTake.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTakeEnvelope.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetTakeNumStretchMarkers.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTakeStretchMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTakeStretchMarkerSlope.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTCPFXParm.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTempoMatchPlayRate.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetToggleCommandState2.is_some() {
            loaded_count += 1;
        }
        if pointers.GetToggleCommandStateEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetToggleCommandStateThroughHooks.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetTrackAutomationMode.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackColor.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackDepth.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackEnvelope.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackEnvelopeByChunkName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackEnvelopeByName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackFromPoint.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackGUID.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackMediaItem.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackMIDILyrics.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackMIDINoteName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackMIDINoteNameEx.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackMIDINoteRange.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackNumMediaItems.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackNumSends.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackReceiveName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackReceiveUIMute.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackReceiveUIVolPan.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackSendInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackSendName.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackSendUIMute.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackSendUIVolPan.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackState.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackStateChunk.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackUIMute.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackUIPan.is_some() {
            loaded_count += 1;
        }
        if pointers.GetTrackUIVolPan.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.GetUserInputs.is_some() {
            loaded_count += 1;
        }
        if pointers.GoToMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.GoToRegion.is_some() {
            loaded_count += 1;
        }
        if pointers.GR_SelectColor.is_some() {
            loaded_count += 1;
        }
        if pointers.GSC_mainwnd.is_some() {
            loaded_count += 1;
        }
        if pointers.guidToString.is_some() {
            loaded_count += 1;
        }
        if pointers.HasExtState.is_some() {
            loaded_count += 1;
        }
        if pointers.HasTrackMIDIPrograms.is_some() {
            loaded_count += 1;
        }
        if pointers.HasTrackMIDIProgramsEx.is_some() {
            loaded_count += 1;
        }
        if pointers.Help_Set.is_some() {
            loaded_count += 1;
        }
        if pointers.HiresPeaksFromSource.is_some() {
            loaded_count += 1;
        }
        if pointers.image_resolve_fn.is_some() {
            loaded_count += 1;
        }
        if pointers.InsertAutomationItem.is_some() {
            loaded_count += 1;
        }
        if pointers.InsertEnvelopePoint.is_some() {
            loaded_count += 1;
        }
        if pointers.InsertEnvelopePointEx.is_some() {
            loaded_count += 1;
        }
        if pointers.InsertMedia.is_some() {
            loaded_count += 1;
        }
        if pointers.InsertMediaSection.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.IsItemTakeActiveForPlayback.is_some() {
            loaded_count += 1;
        }
        if pointers.IsMediaExtension.is_some() {
            loaded_count += 1;
        }
        if pointers.IsMediaItemSelected.is_some() {
            loaded_count += 1;
        }
        if pointers.IsProjectDirty.is_some() {
            loaded_count += 1;
        }
        if pointers.IsREAPER.is_some() {
            loaded_count += 1;
        }
        if pointers.IsTrackSelected.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.joystick_destroy.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_enum.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_getaxis.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_getbuttonmask.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_getinfo.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_getpov.is_some() {
            loaded_count += 1;
        }
        if pointers.joystick_update.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_enumerateActions.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_formatKeyName.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_getCommandName.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_getTextFromCmd.is_some() {
            loaded_count += 1;
        }
        if pointers.KBD_OnMainActionEx.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_OnMidiEvent.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_OnMidiList.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_ProcessActionsMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_processMidiEventActionEx.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_reprocessMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.kbd_RunCommandThroughHooks.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.LICE__DestroyFont.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__DrawText.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__GetBits.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__GetDC.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__GetHeight.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__GetRowSpan.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__GetWidth.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__IsFlipped.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__resize.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__SetBkColor.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__SetFromHFont.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__SetTextColor.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE__SetTextCombineMode.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Arc.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Blit.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Blur.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_BorderedRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Circle.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Clear.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_ClearRect.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.LICE_CreateBitmap.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_CreateFont.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_DrawCBezier.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_DrawChar.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_DrawGlyph.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_DrawRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_DrawText.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillCBezier.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillCircle.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillConvexPolygon.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillTrapezoid.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_FillTriangle.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_GetPixel.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_GradRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_Line.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_LineInt.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_LoadPNG.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_LoadPNGFromResource.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_MeasureText.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_MultiplyAddRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_PutPixel.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_RotatedBlit.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_RoundRect.is_some() {
            loaded_count += 1;
        }
        if pointers.LICE_ScaledBlit.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.Main_OnCommand.is_some() {
            loaded_count += 1;
        }
        if pointers.Main_OnCommandEx.is_some() {
            loaded_count += 1;
        }
        if pointers.Main_openProject.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MarkProjectDirty.is_some() {
            loaded_count += 1;
        }
        if pointers.MarkTrackItemsDirty.is_some() {
            loaded_count += 1;
        }
        if pointers.Master_GetPlayRate.is_some() {
            loaded_count += 1;
        }
        if pointers.Master_GetPlayRateAtTime.is_some() {
            loaded_count += 1;
        }
        if pointers.Master_GetTempo.is_some() {
            loaded_count += 1;
        }
        if pointers.Master_NormalizePlayRate.is_some() {
            loaded_count += 1;
        }
        if pointers.Master_NormalizeTempo.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MIDI_DeleteCC.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_DeleteEvt.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_DeleteNote.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_DeleteTextSysexEvt.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_DisableSort.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_EnumSelCC.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_EnumSelEvts.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_EnumSelNotes.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_EnumSelTextSysexEvts.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_eventlist_Create.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_eventlist_Destroy.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetAllEvts.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetCC.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetCCShape.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetEvt.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetGrid.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetHash.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetNote.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetPPQPos_EndOfMeasure.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetPPQPos_StartOfMeasure.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetPPQPosFromProjQN.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetPPQPosFromProjTime.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_GetProjQNFromPPQPos.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MIDI_GetTextSysexEvt.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MIDI_InsertEvt.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_InsertNote.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MIDI_SelectAll.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetAllEvts.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetCC.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetCCShape.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetEvt.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetItemExtents.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetNote.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDI_SetTextSysexEvt.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.MIDIEditor_GetMode.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDIEditor_GetSetting_int.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDIEditor_GetSetting_str.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDIEditor_GetTake.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDIEditor_LastFocused_OnCommand.is_some() {
            loaded_count += 1;
        }
        if pointers.MIDIEditor_OnCommand.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.mkvolpanstr.is_some() {
            loaded_count += 1;
        }
        if pointers.mkvolstr.is_some() {
            loaded_count += 1;
        }
        if pointers.MoveEditCursor.is_some() {
            loaded_count += 1;
        }
        if pointers.MoveMediaItemToTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.MuteAllTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.my_getViewport.is_some() {
            loaded_count += 1;
        }
        if pointers.NamedCommandLookup.is_some() {
            loaded_count += 1;
        }
        if pointers.OnPauseButton.is_some() {
            loaded_count += 1;
        }
        if pointers.OnPauseButtonEx.is_some() {
            loaded_count += 1;
        }
        if pointers.OnPlayButton.is_some() {
            loaded_count += 1;
        }
        if pointers.OnPlayButtonEx.is_some() {
            loaded_count += 1;
        }
        if pointers.OnStopButton.is_some() {
            loaded_count += 1;
        }
        if pointers.OnStopButtonEx.is_some() {
            loaded_count += 1;
        }
        if pointers.OpenColorThemeFile.is_some() {
            loaded_count += 1;
        }
        if pointers.OpenMediaExplorer.is_some() {
            loaded_count += 1;
        }
        if pointers.OscLocalMessageToHost.is_some() {
            loaded_count += 1;
        }
        if pointers.parse_timestr.is_some() {
            loaded_count += 1;
        }
        if pointers.parse_timestr_len.is_some() {
            loaded_count += 1;
        }
        if pointers.parse_timestr_pos.is_some() {
            loaded_count += 1;
        }
        if pointers.parsepanstr.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_Create.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_CreateEx.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_CreateMIDIFile.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_CreateMIDIFileEx.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_Enum.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Sink_GetExtension.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.PCM_Source_CreateFromFileEx.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Source_CreateFromSimple.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Source_CreateFromType.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Source_Destroy.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Source_GetPeaks.is_some() {
            loaded_count += 1;
        }
        if pointers.PCM_Source_GetSectionInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.PeakBuild_Create.is_some() {
            loaded_count += 1;
        }
        if pointers.PeakBuild_CreateEx.is_some() {
            loaded_count += 1;
        }
        if pointers.PeakGet_Create.is_some() {
            loaded_count += 1;
        }
        if pointers.PitchShiftSubModeMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.PlayPreview.is_some() {
            loaded_count += 1;
        }
        if pointers.PlayPreviewEx.is_some() {
            loaded_count += 1;
        }
        if pointers.PlayTrackPreview.is_some() {
            loaded_count += 1;
        }
        if pointers.PlayTrackPreview2.is_some() {
            loaded_count += 1;
        }
        if pointers.PlayTrackPreview2Ex.is_some() {
            loaded_count += 1;
        }
        if pointers.plugin_getapi.is_some() {
            loaded_count += 1;
        }
        if pointers.plugin_getFilterList.is_some() {
            loaded_count += 1;
        }
        if pointers.plugin_getImportableProjectFilterList.is_some() {
            loaded_count += 1;
        }
        if pointers.plugin_register.is_some() {
            loaded_count += 1;
        }
        if pointers.PluginWantsAlwaysRunFx.is_some() {
            loaded_count += 1;
        }
        if pointers.PreventUIRefresh.is_some() {
            loaded_count += 1;
        }
        if pointers.projectconfig_var_addr.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.ReaScriptError.is_some() {
            loaded_count += 1;
        }
        if pointers.RecursiveCreateDirectory.is_some() {
            loaded_count += 1;
        }
        if pointers.reduce_open_files.is_some() {
            loaded_count += 1;
        }
        if pointers.RefreshToolbar.is_some() {
            loaded_count += 1;
        }
        if pointers.RefreshToolbar2.is_some() {
            loaded_count += 1;
        }
        if pointers.relative_fn.is_some() {
            loaded_count += 1;
        }
        if pointers.RemoveTrackSend.is_some() {
            loaded_count += 1;
        }
        if pointers.RenderFileSection.is_some() {
            loaded_count += 1;
        }
        if pointers.ReorderSelectedTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.Resample_EnumModes.is_some() {
            loaded_count += 1;
        }
        if pointers.Resampler_Create.is_some() {
            loaded_count += 1;
        }
        if pointers.resolve_fn.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.ScaleFromEnvelopeMode.is_some() {
            loaded_count += 1;
        }
        if pointers.ScaleToEnvelopeMode.is_some() {
            loaded_count += 1;
        }
        if pointers.screenset_register.is_some() {
            loaded_count += 1;
        }
        if pointers.screenset_registerNew.is_some() {
            loaded_count += 1;
        }
        if pointers.screenset_unregister.is_some() {
            loaded_count += 1;
        }
        if pointers.screenset_unregisterByParam.is_some() {
            loaded_count += 1;
        }
        if pointers.screenset_updateLastFocus.is_some() {
            loaded_count += 1;
        }
        if pointers.SectionFromUniqueID.is_some() {
            loaded_count += 1;
        }
        if pointers.SelectAllMediaItems.is_some() {
            loaded_count += 1;
        }
        if pointers.SelectProjectInstance.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.SetAutomationMode.is_some() {
            loaded_count += 1;
        }
        if pointers.SetCurrentBPM.is_some() {
            loaded_count += 1;
        }
        if pointers.SetCursorContext.is_some() {
            loaded_count += 1;
        }
        if pointers.SetEditCurPos.is_some() {
            loaded_count += 1;
        }
        if pointers.SetEditCurPos2.is_some() {
            loaded_count += 1;
        }
        if pointers.SetEnvelopePoint.is_some() {
            loaded_count += 1;
        }
        if pointers.SetEnvelopePointEx.is_some() {
            loaded_count += 1;
        }
        if pointers.SetEnvelopeStateChunk.is_some() {
            loaded_count += 1;
        }
        if pointers.SetExtState.is_some() {
            loaded_count += 1;
        }
        if pointers.SetGlobalAutomationOverride.is_some() {
            loaded_count += 1;
        }
        if pointers.SetItemStateChunk.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMasterTrackVisibility.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemLength.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemPosition.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemSelected.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemTake_Source.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaItemTakeInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMediaTrackInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMIDIEditorGrid.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMixerScroll.is_some() {
            loaded_count += 1;
        }
        if pointers.SetMouseModifier.is_some() {
            loaded_count += 1;
        }
        if pointers.SetOnlyTrackSelected.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectGrid.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarker.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarker2.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarker3.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarker4.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarkerByIndex.is_some() {
            loaded_count += 1;
        }
        if pointers.SetProjectMarkerByIndex2.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.SetTakeStretchMarkerSlope.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.SetTrackAutomationMode.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackColor.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackMIDILyrics.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackMIDINoteName.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackMIDINoteNameEx.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackSelected.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackSendInfo_Value.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackSendUIPan.is_some() {
            loaded_count += 1;
        }
        if pointers.SetTrackSendUIVol.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.ShowConsoleMsg.is_some() {
            loaded_count += 1;
        }
        if pointers.ShowMessageBox.is_some() {
            loaded_count += 1;
        }
        if pointers.ShowPopupMenu.is_some() {
            loaded_count += 1;
        }
        if pointers.SLIDER2DB.is_some() {
            loaded_count += 1;
        }
        if pointers.SnapToGrid.is_some() {
            loaded_count += 1;
        }
        if pointers.SoloAllTracks.is_some() {
            loaded_count += 1;
        }
        if pointers.Splash_GetWnd.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.StopTrackPreview.is_some() {
            loaded_count += 1;
        }
        if pointers.StopTrackPreview2.is_some() {
            loaded_count += 1;
        }
        if pointers.stringToGuid.is_some() {
            loaded_count += 1;
        }
        if pointers.StuffMIDIMessage.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_AddByName.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_CopyToTake.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_CopyToTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_Delete.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_EndParamEdit.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_FormatParamValue.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_FormatParamValueNormalized.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetChainVisible.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetCount.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetEnvelope.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetFloatingWindow.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetFormattedParamValue.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetFXGUID.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetFXName.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetIOSize.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetNamedConfigParm.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetNumParams.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetOffline.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetOpen.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetParameterStepSizes.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.TakeFX_GetPreset.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetPresetIndex.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_GetUserPresetFilename.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_NavigatePresets.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetNamedConfigParm.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetOffline.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetOpen.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetParamNormalized.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetPinMappings.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetPreset.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_SetPresetByIndex.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeFX_Show.is_some() {
            loaded_count += 1;
        }
        if pointers.TakeIsMIDI.is_some() {
            loaded_count += 1;
        }
        if pointers.ThemeLayout_GetLayout.is_some() {
            loaded_count += 1;
        }
        if pointers.ThemeLayout_GetParameter.is_some() {
            loaded_count += 1;
        }
        if pointers.ThemeLayout_RefreshAll.is_some() {
            loaded_count += 1;
        }
        if pointers.ThemeLayout_SetLayout.is_some() {
            loaded_count += 1;
        }
        if pointers.ThemeLayout_SetParameter.is_some() {
            loaded_count += 1;
        }
        if pointers.time_precise.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_beatsToTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_GetDividedBpmAtTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_GetNextChangeTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_QNToTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_timeToBeats.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap2_timeToQN.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_curFrameRate.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_GetDividedBpmAtTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_GetMeasureInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_GetMetronomePattern.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_GetTimeSigAtTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_QNToMeasures.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_QNToTime.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_QNToTime_abs.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_timeToQN.is_some() {
            loaded_count += 1;
        }
        if pointers.TimeMap_timeToQN_abs.is_some() {
            loaded_count += 1;
        }
        if pointers.ToggleTrackSendUIMute.is_some() {
            loaded_count += 1;
        }
        if pointers.Track_GetPeakHoldDB.is_some() {
            loaded_count += 1;
        }
        if pointers.Track_GetPeakInfo.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackCtl_SetToolTip.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_AddByName.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_CopyToTake.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_CopyToTrack.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_Delete.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_EndParamEdit.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_FormatParamValue.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_FormatParamValueNormalized.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetByName.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetChainVisible.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetCount.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetEQ.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetEQBandEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetEQParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetFloatingWindow.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetFormattedParamValue.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetFXGUID.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetFXName.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetInstrument.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetIOSize.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetNamedConfigParm.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetNumParams.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetOffline.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetOpen.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetParameterStepSizes.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.TrackFX_GetPreset.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetPresetIndex.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetRecChainVisible.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetRecCount.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_GetUserPresetFilename.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_NavigatePresets.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetEQBandEnabled.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetEQParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetNamedConfigParm.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetOffline.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetOpen.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetParam.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetParamNormalized.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetPinMappings.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetPreset.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_SetPresetByIndex.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackFX_Show.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackList_AdjustWindows.is_some() {
            loaded_count += 1;
        }
        if pointers.TrackList_UpdateAllExternalSurfaces.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_BeginBlock.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_BeginBlock2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_CanRedo2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_CanUndo2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_DoRedo2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_DoUndo2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_EndBlock.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.Undo_OnStateChange2.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_OnStateChange_Item.is_some() {
            loaded_count += 1;
        }
        if pointers.Undo_OnStateChangeEx.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.UpdateArrange.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.ValidatePtr.is_some() {
            loaded_count += 1;
        }
        if pointers.ValidatePtr2.is_some() {
            loaded_count += 1;
        }
        if pointers.ViewPrefs.is_some() {
            loaded_count += 1;
        }
        if pointers.WDL_VirtualWnd_ScaledBlitBG.is_some() {
            loaded_count += 1;
        }
        if pointers.GetMidiInput.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.UninitializeCoolSB.is_some() {
            loaded_count += 1;
        }
        ...
        if pointers.CoolSB_SetScrollPos.is_some() {
            loaded_count += 1;
        }
        if pointers.CoolSB_SetScrollRange.is_some() {
            loaded_count += 1;
        }
        if pointers.CoolSB_ShowScrollBar.is_some() {
            loaded_count += 1;
        }
        if pointers.CoolSB_SetResizingThumb.is_some() {
            loaded_count += 1;
        }
